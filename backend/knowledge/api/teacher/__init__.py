...
from knowledge.api.teacher.map import (
...
from knowledge.api.teacher.relation import (
    knowledge_relation_create,
    knowledge_relation_delete,
    knowledge_relation_list,
)
from knowledge.api.teacher.resource import (
    resource_create,
    resource_delete,
