...
from common.defense_demo.accounts import (
    _ensure_class,
    _ensure_course,
    _ensure_course_only_demo_students,
    ensure_defense_demo_accounts,
)
from common.defense_demo.assessment_state import (
    _ensure_demo_assessment_state,
    _seed_demo_practice_histories,
)
from common.defense_demo.config import (
...
from common.defense_demo.content import (
...
from common.defense_demo.path import _ensure_demo_learning_path
from common.defense_demo.progress import _capture_mastery_snapshot
from common.defense_demo.stage import ensure_warmup_stage_submission_and_feedback
from common.defense_demo.stage_result import build_demo_stage_test_result
