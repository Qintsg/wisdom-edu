...
from platform_ai.rag.student.utils import RankedContext, dedupe_strings, sanitize_answer_text
...
class StudentContextMixin:
    ...
    def _humanize_document_title(self, document: dict[str, object]) -> str:
        """保留旧方法调用形式，委托给共享工具。"""
        from platform_ai.rag.student.utils import humanize_document_title
