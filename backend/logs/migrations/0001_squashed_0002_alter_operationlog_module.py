# Generated by Django 6.0.4 on 2026-05-12 09:12
...
class Migration(migrations.Migration):
    ...
    replaces = [("logs", "0001_initial"), ("logs", "0002_alter_operationlog_module")]
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "request_path",
                    models.CharField(
                        blank=True, max_length=500, null=True, verbose_name="请求路径"
                    ),
                ),
                (
                    "request_method",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="operation_l_user_id_0c8567_idx",
                    ),
                    models.Index(
                        fields=["action_type", "created_at"],
                        name="operation_l_action__95992b_idx",
                    ),
                    models.Index(
                        fields=["module", "created_at"],
                        name="operation_l_module_f1a84a_idx",
                    ),
                ],
            },
        ),
