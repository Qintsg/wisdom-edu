...
from logs.runtime.descriptions import generate_operation_description
from logs.runtime.logging_setup import (
    DEBUG_LOG_DB_QUERIES,
    MODULE_DISPLAY,
    debug_logger,
    operation_logger,
)
from logs.runtime.middleware_config import (
    EXCLUDE_PATTERNS as LOG_EXCLUDE_PATTERNS,
    METHOD_ACTION_MAP as LOG_METHOD_ACTION_MAP,
    PATH_MODULE_MAP as LOG_PATH_MODULE_MAP,
)
...
class OperationLogMiddleware(MiddlewareMixin):
    ...
    EXCLUDE_PATTERNS = LOG_EXCLUDE_PATTERNS
    PATH_MODULE_MAP = LOG_PATH_MODULE_MAP
    METHOD_ACTION_MAP = LOG_METHOD_ACTION_MAP
