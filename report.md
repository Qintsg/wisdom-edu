...
|:-----|------:|------:|------:|------:|:------:|
| 循环复杂度 | 6.25% | 0.0% | 65.5% | 0.0% | ✓✓ |
| 认知复杂度 | 7.41% | 0.0% | 57.8% | 0.0% | ✓✓ |
| 嵌套深度 | 0.54% | 0.0% | 20.0% | 0.0% | ✓✓ |
| 函数长度 | 6.43% | 0.0% | 75.9% | 0.0% | ✓✓ |
| 文件长度 | 0.56% | 0.0% | 48.2% | 0.0% | ✓✓ |
| 参数数量 | 6.69% | 0.0% | 98.5% | 0.0% | ✓✓ |
| 代码重复 | 3.08% | 0.0% | 94.2% | 0.0% | ✓✓ |
| 结构分析 | 1.08% | 0.0% | 16.0% | 0.0% | ✓✓ |
| 错误处理 | 18.12% | 0.0% | 98.8% | 0.0% | ✓✓ |
| 注释比例 | 77.17% | 0.0% | 100.0% | 100.0% | ! |
| 命名规范 | 17.35% | 0.0% | 100.0% | 0.0% | ✓✓ |

## 最屎代码排行榜 {#problem-files}

### 1. backend\platform_ai\rag\student_answer_mixin.py
...
### 2. backend\exams\student_initial_assessment_views.py
...
### 3. backend\ai_services\services\llm_feedback_kt_mixin.py
...
### 4. backend\tools\api_regression_cleanup.py
...
### 6. backend\users\student_views.py
...
### 7. backend\tools\db_demo_preset.py
...
### 8. backend\tools\mefkt_training.py
...
### 9. backend\ai_services\services\llm_response_mixin.py
...
### 10. backend\common\question_options.py
...
### 11. backend\ai_services\services\mefkt_inference.py

**糟糕指数: 23.62**

> 行数: 376 总计, 334 代码, 2 注释 | 函数: 13 | 类: 1

**问题**: 🔄 复杂度问题: 3, ⚠️ 其他问题: 4, 🏗️ 结构问题: 1, ❌ 错误处理问题: 9, 📝 注释问题: 1, 🏷️ 命名问题: 8

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `load_model` | L67-157 | 91 | 23 | 2 | 3 | ✓ |
| `_predict_legacy` | L242-297 | 56 | 8 | 3 | 3 | ✓ |
| `_resolve_backend_path` | L30-40 | 11 | 4 | 1 | 1 | ✓ |
| `_build_history_tensors_legacy` | L159-187 | 29 | 4 | 2 | 2 | ✓ |
| `_resolve_runtime_history_index` | L197-212 | 16 | 4 | 2 | 3 | ✓ |
| `predict` | L330-348 | 19 | 4 | 2 | 4 | ✓ |
| `_build_history_tensors_runtime` | L214-240 | 27 | 3 | 2 | 3 | ✓ |
| `is_loaded` | L63-65 | 3 | 2 | 0 | 1 | ✓ |
| `_build_course_runtime_bundle` | L189-195 | 7 | 2 | 1 | 2 | ✓ |
| `_predict_question_online` | L299-328 | 30 | 2 | 0 | 4 | ✓ |
| `__init__` | L46-60 | 15 | 1 | 0 | 1 | ✗ |
| `get_info` | L350-365 | 16 | 1 | 0 | 1 | ✓ |
| `auto_load_model` | L371-375 | 5 | 1 | 0 | 0 | ✓ |

**全部问题 (23)**

- 🔄 `load_model()` L67: 复杂度: 23
- 🔄 `load_model()` L67: 认知复杂度: 27
- 🔄 `_predict_legacy()` L242: 认知复杂度: 14
- 📏 `load_model()` L67: 91 代码量
- 📏 `_predict_legacy()` L242: 56 代码量
- 🏗️ `_predict_legacy()` L242: 中等嵌套: 3
- ❌ L110: 未处理的易出错调用
- ❌ L117: 未处理的易出错调用
- ❌ L358: 未处理的易出错调用
- ❌ L359: 未处理的易出错调用
...
- ❌ L363: 未处理的易出错调用
- ❌ L364: 未处理的易出错调用
- 🏷️ `_resolve_backend_path()` L30: "_resolve_backend_path" - snake_case
- 🏷️ `__init__()` L46: "__init__" - snake_case
- 🏷️ `_build_history_tensors_legacy()` L159: "_build_history_tensors_legacy" - snake_case
- 🏷️ `_build_course_runtime_bundle()` L189: "_build_course_runtime_bundle" - snake_case
- 🏷️ `_resolve_runtime_history_index()` L197: "_resolve_runtime_history_index" - snake_case
- 🏷️ `_build_history_tensors_runtime()` L214: "_build_history_tensors_runtime" - snake_case
- 🏷️ `_predict_legacy()` L242: "_predict_legacy" - snake_case
- 🏷️ `_predict_question_online()` L299: "_predict_question_online" - snake_case

**详情**:
- 循环复杂度: 平均: 4.5, 最大: 23
- 认知复杂度: 平均: 6.8, 最大: 27
- 嵌套深度: 平均: 1.2, 最大: 3
- 函数长度: 平均: 25.0 行, 最大: 91 行
- 文件长度: 334 代码量 (376 总计)
- 参数数量: 平均: 2.2, 最大: 4
- 代码重复: 0.0% 重复 (0/13)
- 结构分析: 1 个结构问题
- 错误处理: 9/25 个错误被忽略 (36.0%)
- 注释比例: 0.6% (2/334)
- 命名规范: 发现 8 个违规
...
### 150. backend\ai_services\services\mefkt_question_online.py
...
### 151. frontend\src\components\knowledge\useKnowledgeGraphD3.js
...
### 152. backend\models\MEFKT\sequence.py
...
### 153. backend\exams\student_submission_views.py
...
### 154. backend\learning\path_adjustment.py
...
### 155. backend\ai_services\test_llm_service.py
...
### 156. backend\assessments\ability_views.py
...
### 157. frontend\src\views\student\useTaskLearning.js
...
### 173. backend\knowledge\teacher_map_views.py
...
### 174. backend\common\defense_demo_progress.py
...
### 177. backend\exams\student_feedback_views.py
...
### 178. frontend\src\views\student\useExamTaking.js
...
### 181. backend\exams\teacher_question_views.py
...
### 182. backend\tools\api_regression_student.py
...
### 184. backend\exams\teacher_result_views.py
...
### 185. backend\tools\excel_templates.py
...
### 189. backend\models\MEFKT\graph.py
...
### 190. backend\models\DKT\KnowledgeTracing\data\readdata.py
...
### 191. backend\common\defense_demo_environment.py
...
### 192. frontend\src\api\backend.ts
...
### 194. frontend\src\views\teacher\useTeacherExamManage.js
...
### 195. frontend\src\views\student\taskLearningModels.js
...
### 196. backend\users\teacher_views.py
...
### 204. backend\models\DKT\KnowledgeTracing\evaluation\eval.py
...
### 228. frontend\src\api\student\ai.ts
...
### 229. backend\application\teacher\contracts.py
...
### 230. backend\users\serializers.py
...
### 231. backend\logs\logging_setup.py
...
### 232. backend\assessments\question_models.py
...
### 233. backend\assessments\history_models.py
...
### 234. backend\ai_services\models.py
...
### 236. frontend\src\views\student\useProfileView.js
...
### 237. backend\application\teacher\workspace.py
...
### 238. backend\assessments\assessment_models.py
...
### 240. backend\ai_services\test_web_search.py
...
### 241. backend\knowledge\models.py
...
### 243. backend\platform_ai\kt\torch_device.py
...
### 244. backend\exams\score_policy.py
...
### 245. frontend\src\views\student\profileModels.js
...
### 246. backend\learning\models.py
...
### 248. backend\platform_ai\search\providers.py
...
### 249. backend\exams\serializers.py
...
### 251. backend\models\DKT\KnowledgeTracing\data\DKTDataSet.py
...
### 252. frontend\src\api\errors.ts
...
### 254. frontend\src\views\student\useFeedbackReport.js
...
### 255. backend\ai_services\auth.py
...
### 256. backend\models\DKT\KnowledgeTracing\model\RNNModel.py
...
### 257. frontend\src\views\teacher\useTeacherKnowledgeManage.js
...
### 258. backend\common\pagination.py
...
### 259. backend\wisdom_edu_api\wsgi.py
...
### 260. backend\wisdom_edu_api\asgi.py
...
### 264. backend\users\admin_views.py
...
### 266. backend\logs\serializers.py
...
### 269. backend\learning\stage_test_submit_views.py
...
### 270. backend\learning\stage_test_models.py
...
### 271. backend\learning\stage_test_get_views.py
...
### 274. backend\knowledge\views.py
...
### 275. backend\knowledge\teacher_views.py
...
### 277. backend\knowledge\admin.py
...
### 278. backend\exams\teacher_views.py
...
### 279. backend\exams\student_class_views.py
...
### 282. backend\courses\teacher_views.py
...
### 283. backend\courses\serializers.py
...
### 284. backend\courses\course_cleanup.py
...
### 287. backend\common\test_responses.py
...
### 292. backend\assessments\views.py
...
### 293. backend\assessments\models.py
...
### 294. backend\assessments\habit_survey_defaults.py
...
### 295. backend\assessments\apps.py
...
### 296. backend\assessments\admin.py
...
### 297. backend\assessments\ability_survey_defaults.py
...
### 306. frontend\src\utils\markdown.ts
...
### 307. frontend\src\stores\index.ts
...
### 309. frontend\src\api\course.ts
...
### 310. frontend\src\api\authTokens.ts
...
### 312. backend\platform_ai\search\__init__.py
...
### 313. backend\platform_ai\mcp\__init__.py
...
### 314. backend\platform_ai\rag\__init__.py
...
### 315. backend\platform_ai\rag\student.py
...
### 316. backend\platform_ai\rag\runtime_course.py
...
### 317. backend\platform_ai\rag\corpus_types.py
...
### 318. backend\platform_ai\rag\corpus_storage.py
...
### 319. backend\platform_ai\rag\corpus.py
...
### 320. backend\platform_ai\llm\__init__.py
...
### 321. backend\platform_ai\llm\facade.py
...
### 322. backend\platform_ai\kt\__init__.py
...
### 323. backend\platform_ai\kt\facade.py
...
### 324. backend\platform_ai\kt\datasets.py
...
### 325. backend\models\MEFKT\constants.py
...
### 327. backend\application\teacher\__init__.py
...
### 330. frontend\src\views\teacher\resourceManageModels.js
...
### 331. frontend\src\components\knowledge\knowledgeGraphModels.js
...
### 332. frontend\src\api\teacher\settings.ts
...
### 333. frontend\src\api\teacher\question.ts
...
### 334. frontend\src\api\teacher\knowledge.ts
...
### 335. frontend\src\api\teacher\index.ts
...
### 336. frontend\src\api\teacher\exam.ts
...
### 337. frontend\src\api\teacher\course.ts
...
### 338. frontend\src\api\teacher\class.ts
...
### 339. frontend\src\api\student\profile.ts
...
### 340. frontend\src\api\student\learning.ts
...
### 341. frontend\src\api\student\knowledge.ts
...
### 342. frontend\src\api\student\index.ts
...
### 343. frontend\src\api\student\exam.ts
...
### 344. frontend\src\api\student\class.ts
...
### 345. frontend\src\api\student\assessment.ts
...
### 346. frontend\src\api\admin\user.ts
...
### 347. frontend\src\api\admin\statistics.ts
...
### 348. frontend\src\api\admin\profile.ts
...
### 349. frontend\src\api\admin\log.ts
...
### 350. frontend\src\api\admin\course.ts
...
### 351. frontend\src\api\admin\class.ts
...
### 352. frontend\src\api\admin\activation.ts
...
### 353. backend\users\auth_password_views.py
...
### 354. frontend\src\api\common.ts
...
### 355. backend\models\DKT\KnowledgeTracing\evaluation\run.py
...
### 356. backend\tools\browser_audit.py
...
### 357. backend\ai_services\migrations\0001_initial.py
...
### 358. frontend\src\router\guards.ts
...
### 359. backend\ai_services\services\llm_provider_config.py
...
### 360. backend\exams\migrations\0001_initial.py
...
### 361. backend\logs\migrations\0001_initial.py
...
### 362. frontend\src\composables\useCourse.ts
...
### 363. backend\learning\migrations\0001_initial.py
...
### 364. backend\assessments\migrations\0001_initial.py
...
### 366. backend\knowledge\migrations\0001_initial.py
...
### 367. backend\courses\migrations\0001_initial.py
...
### 368. backend\users\migrations\0001_initial.py
...
### 369. backend\tools\rebuild_demo.py
...
### 370. backend\courses\admin_course_class_stats_views.py
...
### 373. frontend\src\utils\courseCover.ts
...
### 374. backend\assessments\migrations\0004_alter_surveyquestion_options_and_more.py
...
### 375. backend\users\migrations\0005_remove_habitpreference_reminder_settings.py
...
### 377. frontend\src\composables\useAIProgress.ts
...
### 378. backend\courses\migrations\0005_announcement.py
...
### 379. backend\exams\student_views.py
...
### 381. backend\users\migrations\0004_alter_habitpreference_review_frequency.py
...
### 382. backend\logs\migrations\0002_alter_operationlog_module.py
...
### 383. backend\learning\migrations\0005_nodeprogress_extra_data.py
...
### 384. backend\learning\migrations\0003_add_skipped_status.py
...
### 385. backend\knowledge\migrations\0005_alter_knowledgerelation_relation_type.py
...
### 386. backend\courses\migrations\0004_course_config.py
...
### 387. backend\ai_services\migrations\0003_add_chat_kt_call_types.py
...
### 388. frontend\src\utils\logger.ts
...
### 389. backend\users\migrations\0002_habitpreference_accept_challenge_and_more.py
...
### 391. backend\users\migrations\0003_alter_user_email_alter_user_phone.py
...
### 392. backend\learning\migrations\0004_pathnode_estimated_minutes_pathnode_node_type.py
...
### 393. backend\assessments\migrations\0006_assessmentstatus_generating_and_more.py
...
### 394. backend\assessments\migrations\0005_question_chapter_question_suggested_score.py
...
### 395. backend\assessments\migrations\0002_initial.py
...
### 396. backend\knowledge\migrations\0004_resource_chapter_number_resource_duration_and_more.py
...
### 397. backend\common\defense_demo.py
...
### 398. backend\courses\migrations\0003_alter_class_options_class_description_and_more.py
...
### 399. backend\ai_services\migrations\0002_initial.py
...
### 400. backend\common\permissions.py
...
### 401. backend\knowledge\migrations\0003_knowledgepoint_category_and_more.py
...
### 402. frontend\src\stores\assessment.ts
...
### 403. frontend\src\router\routes\auth.ts
...
### 404. backend\wisdom_edu_api\urls.py
...
### 405. backend\platform_ai\__init__.py
...
### 406. backend\courses\migrations\0002_initial.py
...
### 407. backend\exams\migrations\0003_alter_feedbackreport_unique_together_and_more.py
...
### 410. backend\exams\migrations\0002_initial.py
...
### 411. backend\knowledge\migrations\0002_initial.py
...
### 412. backend\assessments\migrations\0003_initial.py
...
### 414. frontend\src\router\index.ts
...
### 416. backend\courses\signals.py
...
### 417. backend\ai_services\services\mefkt_loader.py
...
### 418. frontend\src\router\routes\teacher.ts
...
### 420. backend\models\MEFKT\__init__.py
...
### 421. frontend\src\router\routes\student.ts
...
### 424. backend\knowledge\migrations\0006_knowledgepoint_introduction_fields.py
...
### 425. backend\models\MEFKT\model.py
...
### 427. backend\models\DKT\KnowledgeTracing\Constant\Constants.py
...
### 429. backend\wisdom_edu_api\__init__.py
...
### 431. backend\tools\mefkt_paths.py
...
### 435. backend\learning\__init__.py
...
### 437. backend\knowledge\__init__.py
...
### 440. backend\courses\__init__.py
...
### 443. backend\common\__init__.py
...
### 445. backend\assessments\__init__.py
...
### 446. backend\assessments\urls.py
...
### 447. backend\ai_services\__init__.py
...
### 448. backend\users\migrations\__init__.py
...
### 449. backend\logs\migrations\__init__.py
...
### 450. backend\learning\migrations\__init__.py
...
### 451. backend\knowledge\migrations\__init__.py
...
### 452. backend\exams\migrations\__init__.py
...
### 454. backend\common\migrations\__init__.py
...
### 455. backend\assessments\migrations\__init__.py
...
### 456. backend\ai_services\migrations\__init__.py
...
### 457. frontend\src\router\routes\admin.ts
...
### 458. frontend\src\api\admin\index.ts
...
### 459. backend\models\DKT\KnowledgeTracing\model\__init__.py
...
### 460. backend\models\DKT\KnowledgeTracing\evaluation\__init__.py
...
### 461. backend\models\DKT\KnowledgeTracing\data\__init__.py
...
### 462. backend\models\DKT\KnowledgeTracing\Constant\__init__.py
