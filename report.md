...
![Score](https://img.shields.io/badge/Score-98%25-brightgreen)
...
| 整体注释比例 | 5.9% |
| 平均文件大小 | 144 行 |
| 最大文件 | `backend\logs\middleware.py` (483) |
...
|:-----|------:|------:|------:|------:|:------:|
| 循环复杂度 | 3.76% | 0.0% | 56.7% | 0.0% | ✓✓ |
| 认知复杂度 | 5.06% | 0.0% | 41.9% | 0.0% | ✓✓ |
| 嵌套深度 | 0.26% | 0.0% | 10.0% | 0.0% | ✓✓ |
| 函数长度 | 4.53% | 0.0% | 75.9% | 0.0% | ✓✓ |
| 文件长度 | 0.36% | 0.0% | 14.1% | 0.0% | ✓✓ |
| 参数数量 | 7.20% | 0.0% | 98.5% | 0.0% | ✓✓ |
| 代码重复 | 2.95% | 0.0% | 94.2% | 0.0% | ✓✓ |
| 结构分析 | 0.75% | 0.0% | 15.0% | 0.0% | ✓✓ |
| 错误处理 | 18.24% | 0.0% | 98.8% | 0.0% | ✓✓ |
| 注释比例 | 79.80% | 0.0% | 100.0% | 100.0% | ! |
| 命名规范 | 14.21% | 0.0% | 100.0% | 0.0% | ✓✓ |

## 最屎代码排行榜 {#problem-files}

### 1. backend\logs\middleware.py
...
### 2. backend\exams\teacher_exam_management_views.py
...
### 3. backend\tools\knowledge_import_support.py
...
### 4. backend\tools\mefkt_public_data.py
...
### 5. backend\knowledge\teacher_question_views.py
...
### 6. backend\platform_ai\rag\student_retrieval_mixin.py
...
### 7. backend\tools\cli_parser.py

**糟糕指数: 8.53**

> 行数: 351 总计, 301 代码, 2 注释 | 函数: 8 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `_dispatch_import_commands` | L218-250 | 33 | 15 | 1 | 1 | ✓ |
| `_dispatch_data_admin_commands` | L253-281 | 29 | 13 | 1 | 1 | ✓ |
| `_dispatch_test_commands` | L284-306 | 23 | 10 | 1 | 1 | ✓ |
| `_dispatch_training_commands` | L309-335 | 27 | 5 | 1 | 1 | ✓ |
| `dispatch_command` | L346-350 | 5 | 3 | 2 | 1 | ✓ |
| `_parse_model_filters` | L211-215 | 5 | 2 | 1 | 1 | ✓ |
| `_add_json_import_args` | L43-48 | 6 | 1 | 0 | 1 | ✓ |
| `build_parser` | L51-208 | 158 | 1 | 0 | 0 | ✓ |

**全部问题 (12)**

- 🔄 `_dispatch_import_commands()` L218: 复杂度: 15
- 🔄 `_dispatch_data_admin_commands()` L253: 复杂度: 13
- 🔄 `_dispatch_import_commands()` L218: 认知复杂度: 17
- 🔄 `_dispatch_data_admin_commands()` L253: 认知复杂度: 15
- 📏 `build_parser()` L51: 158 代码量
- 🏗️ L1: 导入过多: 23
- 🏷️ `_add_json_import_args()` L43: "_add_json_import_args" - snake_case
- 🏷️ `_parse_model_filters()` L211: "_parse_model_filters" - snake_case
- 🏷️ `_dispatch_import_commands()` L218: "_dispatch_import_commands" - snake_case
- 🏷️ `_dispatch_data_admin_commands()` L253: "_dispatch_data_admin_commands" - snake_case
- 🏷️ `_dispatch_test_commands()` L284: "_dispatch_test_commands" - snake_case
- 🏷️ `_dispatch_training_commands()` L309: "_dispatch_training_commands" - snake_case
...
### 8. backend\platform_ai\rag\corpus_builder.py
...
### 9. backend\tools\cli_menu.py

**糟糕指数: 8.14**

> 行数: 322 总计, 288 代码, 2 注释 | 函数: 11 | 类: 0

**问题**: 🔄 复杂度问题: 6, 🏗️ 结构问题: 1, 📝 注释问题: 1, 🏷️ 命名问题: 10

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `_handle_data_menu_choice` | L112-156 | 45 | 15 | 2 | 1 | ✓ |
| `_handle_graphrag_and_demo_menu_choice` | L255-284 | 30 | 15 | 2 | 1 | ✓ |
| `_handle_kt_menu_choice` | L222-252 | 31 | 12 | 1 | 1 | ✓ |
| `_handle_neo4j_menu_choice` | L179-199 | 21 | 7 | 1 | 1 | ✓ |
| `_handle_database_menu_choice` | L159-176 | 18 | 6 | 1 | 1 | ✓ |
| `_handle_api_and_service_menu_choice` | L202-219 | 18 | 6 | 1 | 1 | ✓ |
| `_handle_menu_choice` | L297-308 | 12 | 4 | 2 | 1 | ✓ |
| `show_menu` | L311-321 | 11 | 4 | 3 | 0 | ✓ |
| `_render_menu` | L88-95 | 8 | 2 | 1 | 0 | ✓ |
| `_parse_optional_course_id` | L98-101 | 4 | 2 | 0 | 1 | ✓ |
| `_prompt_yes_no` | L104-109 | 6 | 2 | 1 | 2 | ✓ |

**全部问题 (17)**

- 🔄 `_handle_data_menu_choice()` L112: 复杂度: 15
- 🔄 `_handle_kt_menu_choice()` L222: 复杂度: 12
- 🔄 `_handle_graphrag_and_demo_menu_choice()` L255: 复杂度: 15
- 🔄 `_handle_data_menu_choice()` L112: 认知复杂度: 19
- 🔄 `_handle_kt_menu_choice()` L222: 认知复杂度: 14
- 🔄 `_handle_graphrag_and_demo_menu_choice()` L255: 认知复杂度: 19
- 🏗️ `show_menu()` L311: 中等嵌套: 3
- 🏷️ `_render_menu()` L88: "_render_menu" - snake_case
- 🏷️ `_parse_optional_course_id()` L98: "_parse_optional_course_id" - snake_case
- 🏷️ `_prompt_yes_no()` L104: "_prompt_yes_no" - snake_case
- 🏷️ `_handle_data_menu_choice()` L112: "_handle_data_menu_choice" - snake_case
- 🏷️ `_handle_database_menu_choice()` L159: "_handle_database_menu_choice" - snake_case
- 🏷️ `_handle_neo4j_menu_choice()` L179: "_handle_neo4j_menu_choice" - snake_case
- 🏷️ `_handle_api_and_service_menu_choice()` L202: "_handle_api_and_service_menu_choice" - snake_case
- 🏷️ `_handle_kt_menu_choice()` L222: "_handle_kt_menu_choice" - snake_case
- 🏷️ `_handle_graphrag_and_demo_menu_choice()` L255: "_handle_graphrag_and_demo_menu_choice" - snake_case
- 🏷️ `_handle_menu_choice()` L297: "_handle_menu_choice" - snake_case
...
### 10. backend\ai_services\student_ai_profile_views.py
...
### 11. backend\courses\admin_views.py
...
### 12. backend\tools\bootstrap_support.py
...
### 13. backend\exams\report_service.py
...
### 14. backend\knowledge\teacher_map_support.py
...
### 15. backend\platform_ai\rag\runtime_models.py
...
### 16. backend\exams\student_submission_support.py
...
### 18. backend\ai_services\services\llm_service.py
...
### 19. backend\ai_services\services\scoring_service.py
...
### 21. backend\ai_services\test_llm_service.py

**糟糕指数: 6.67**

> 行数: 400 总计, 333 代码, 0 注释 | 函数: 17 | 类: 5
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `test_agent_graphrag_tool_should_call_public_payload_builder` | L334-360 | 27 | 2 | 1 | 1 | ✓ |
| `test_facade_graphrag_llm_should_instantiate_without_legacy_warning` | L366-375 | 10 | 2 | 1 | 1 | ✓ |
| `test_facade_graphrag_llm_should_accept_v2_message_lists` | L377-399 | 23 | 2 | 1 | 1 | ✓ |
| `test_llm_service_should_resolve_explicit_doubao_provider` | L47-56 | 10 | 1 | 0 | 1 | ✓ |
| `test_llm_service_should_resolve_custom_gateway_fields` | L67-76 | 10 | 1 | 0 | 1 | ✓ |
| `test_llm_service_should_attach_https_proxy_to_chat_client` | L89-103 | 15 | 1 | 0 | 2 | ✓ |
| `test_llm_service_should_default_deepseek_v4_to_non_thinking_mode` | L117-136 | 20 | 1 | 0 | 2 | ✓ |
| `test_external_resource_recommendation_should_enable_provider_web_search` | L150-179 | 30 | 1 | 0 | 2 | ✓ |
| `test_llm_json_parser_should_ignore_think_blocks` | L181-189 | 9 | 1 | 0 | 1 | ✓ |
| `_build_service` | L196-201 | 6 | 1 | 0 | 0 | ✗ |
| `test_call_with_fallback_should_skip_agent_for_profile_analysis` | L203-221 | 19 | 1 | 0 | 1 | ✓ |
| `test_call_with_fallback_should_only_use_agent_for_explicit_agent_calls` | L223-239 | 17 | 1 | 0 | 1 | ✓ |
| `_build_service` | L246-251 | 6 | 1 | 0 | 0 | ✗ |
| `test_call_with_fallback_should_fast_fail_graph_rag_calls_without_repair` | L253-277 | 25 | 1 | 0 | 1 | ✓ |
| `test_call_with_fallback_should_keep_repair_for_profile_analysis` | L279-294 | 16 | 1 | 0 | 1 | ✓ |
| `test_chat_policy_should_fast_fail_like_other_interactive_routes` | L296-305 | 10 | 1 | 0 | 1 | ✓ |
| `test_agent_service_should_forward_proxy_to_chat_openai` | L322-332 | 11 | 1 | 0 | 2 | ✓ |

**全部问题 (3)**

- 📋 `test_llm_service_should_attach_https_proxy_to_chat_client()` L89: 重复模式: test_llm_service_should_attach_https_proxy_to_chat_client, test_llm_service_should_default_deepseek_v4_to_non_thinking_mode
- 📋 `test_call_with_fallback_should_only_use_agent_for_explicit_agent_calls()` L223: 重复模式: test_call_with_fallback_should_only_use_agent_for_explicit_agent_calls, test_call_with_fallback_should_keep_repair_for_profile_analysis, test_facade_graphrag_llm_should_accept_v2_message_lists
- 🏗️ L1: 导入过多: 33
...
### 22. backend\ai_services\test_kt_models.py

**糟糕指数: 6.67**

> 行数: 435 总计, 388 代码, 2 注释 | 函数: 10 | 类: 3
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `test_mefkt_predictor_should_load_checkpoint_and_return_predictions` | L55-114 | 60 | 3 | 2 | 1 | ✓ |
| `test_mefkt_predictor_should_support_question_online_runtime` | L116-244 | 129 | 3 | 2 | 1 | ✓ |
| `test_predict_mastery_should_degrade_gracefully_on_model_name_error` | L272-301 | 30 | 2 | 1 | 1 | ✓ |
| `test_predict_mastery_should_return_course_defaults_without_history` | L303-327 | 25 | 2 | 1 | 1 | ✓ |
| `test_kt_service_model_info_should_expose_mefkt_config` | L37-53 | 17 | 1 | 0 | 1 | ✓ |
| `test_mefkt_perceived_distance_should_increase_with_longer_gap` | L246-266 | 21 | 1 | 0 | 1 | ✓ |
| `setUp` | L333-382 | 50 | 1 | 0 | 1 | ✓ |
| `_profile` | L384-398 | 15 | 1 | 0 | 3 | ✓ |
| `test_kp_profile_should_reflect_prerequisite_depth_and_item_difficulty` | L400-406 | 7 | 1 | 0 | 1 | ✓ |
| `test_simulated_sequences_should_show_ability_gap_and_revisits` | L408-434 | 27 | 1 | 0 | 1 | ✓ |

**全部问题 (6)**

- 📏 `test_mefkt_predictor_should_load_checkpoint_and_return_predictions()` L55: 60 代码量
- 📏 `test_mefkt_predictor_should_support_question_online_runtime()` L116: 129 代码量
- 📋 `test_mefkt_predictor_should_load_checkpoint_and_return_predictions()` L55: 重复模式: test_mefkt_predictor_should_load_checkpoint_and_return_predictions, test_simulated_sequences_should_show_ability_gap_and_revisits
- 🏗️ L1: 导入过多: 32
- 🏷️ `setUp()` L333: "setUp" - snake_case
- 🏷️ `_profile()` L384: "_profile" - snake_case
...
### 23. backend\ai_services\services\llm_resource_support.py
...
### 24. backend\tools\question_import_excel.py

**糟糕指数: 6.27**

> 行数: 184 总计, 157 代码, 2 注释 | 函数: 6 | 类: 0

**问题**: 🔄 复杂度问题: 4, 🏗️ 结构问题: 1, 📝 注释问题: 1

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `build_excel_question_payload` | L79-122 | 44 | 20 | 1 | 3 | ✓ |
| `extract_question_content` | L52-61 | 10 | 9 | 2 | 2 | ✓ |
| `iter_excel_question_payloads` | L155-183 | 29 | 7 | 3 | 3 | ✓ |
| `build_excel_options` | L64-76 | 13 | 6 | 2 | 2 | ✓ |
| `open_question_bank_workbook` | L125-152 | 28 | 6 | 2 | 2 | ✓ |
| `row_get` | L44-49 | 6 | 2 | 1 | 2 | ✓ |

**全部问题 (5)**

- 🔄 `build_excel_question_payload()` L79: 复杂度: 20
- 🔄 `extract_question_content()` L52: 认知复杂度: 13
- 🔄 `build_excel_question_payload()` L79: 认知复杂度: 22
- 🔄 `iter_excel_question_payloads()` L155: 认知复杂度: 13
- 🏗️ `iter_excel_question_payloads()` L155: 中等嵌套: 3

**详情**:
- 循环复杂度: 平均: 8.3, 最大: 20
- 认知复杂度: 平均: 12.0, 最大: 22
- 嵌套深度: 平均: 1.8, 最大: 3
- 函数长度: 平均: 21.7 行, 最大: 44 行
- 文件长度: 157 代码量 (184 总计)
- 参数数量: 平均: 2.3, 最大: 3
- 代码重复: 0.0% 重复 (0/6)
- 结构分析: 1 个结构问题
...
### 25. backend\tools\db_seed_support.py
...
### 26. backend\ai_services\services\llm_response_support.py
...
### 28. frontend\src\views\student\taskLearningModels.js
...
### 29. backend\assessments\knowledge_views.py
...
### 30. backend\tools\api_regression_helpers.py
...
### 31. backend\platform_ai\rag\runtime_search_mixin.py
...
### 33. backend\tools\demo_course_archive.py
...
### 35. backend\common\course_utils.py
...
### 38. backend\courses\teacher_workspace_views.py
...
### 41. backend\platform_ai\rag\student_context_mixin.py
...
### 43. backend\knowledge\teacher_point_views.py
...
### 44. backend\courses\teacher_class_views.py
...
### 45. backend\tools\ai_services_test.py
...
### 46. backend\knowledge\teacher_map_views.py
...
### 47. backend\common\defense_demo_assessment_state.py
...
### 48. backend\learning\path_rules.py
...
### 49. backend\ai_services\services\web_search_service.py
...
### 50. backend\platform_ai\rag\runtime.py
...
### 51. backend\tools\db_management.py
...
### 52. backend\knowledge\map_views.py

**糟糕指数: 3.88**

> 行数: 239 总计, 204 代码, 0 注释 | 函数: 6 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `update_knowledge_mastery` | L201-238 | 38 | 10 | 3 | 1 | ✓ |
| `get_knowledge_point_detail` | L71-123 | 53 | 7 | 2 | 2 | ✓ |
| `get_knowledge_points_list` | L154-183 | 30 | 6 | 1 | 1 | ✓ |
| `get_knowledge_map` | L33-66 | 34 | 5 | 1 | 1 | ✓ |
| `get_knowledge_relations` | L128-149 | 22 | 3 | 1 | 1 | ✓ |
| `get_knowledge_mastery` | L188-196 | 9 | 2 | 1 | 1 | ✓ |

**全部问题 (6)**

- 🔄 `update_knowledge_mastery()` L201: 认知复杂度: 16
- 📏 `get_knowledge_point_detail()` L71: 53 代码量
- 🏗️ `update_knowledge_mastery()` L201: 中等嵌套: 3
- ❌ L51: 未处理的易出错调用
- ❌ L97: 未处理的易出错调用
- ❌ L100: 未处理的易出错调用
...
### 55. backend\ai_services\services\kt_prediction_stats.py

**糟糕指数: 3.73**

> 行数: 198 总计, 171 代码, 0 注释 | 函数: 7 | 类: 1
...
| `_get_default_prediction` | L183-197 | 15 | 3 | 2 | 2 | ✓ |
| `_prepare_input_data` | L163-181 | 19 | 1 | 0 | 1 | ✓ |
...
- 🏷️ `_get_default_prediction()` L183: "_get_default_prediction" - snake_case
...
### 57. backend\assessments\knowledge_assessment_logic.py
...
### 58. backend\tools\question_import_knowledge.py

**糟糕指数: 3.58**

> 行数: 99 总计, 80 代码, 2 注释 | 函数: 5 | 类: 0

**问题**: 🔄 复杂度问题: 1, ⚠️ 其他问题: 1, 🏗️ 结构问题: 1, 📝 注释问题: 1

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `match_knowledge_point_by_topic` | L34-54 | 21 | 9 | 3 | 2 | ✓ |
| `normalize_knowledge_point_names` | L23-31 | 9 | 4 | 1 | 1 | ✓ |
| `link_question_knowledge_points` | L67-87 | 21 | 4 | 2 | 4 | ✓ |
| `resolve_filename_knowledge_point` | L90-98 | 9 | 2 | 1 | 2 | ✓ |
| `build_question_import_context` | L57-64 | 8 | 1 | 0 | 1 | ✓ |

**全部问题 (2)**

- 🔄 `match_knowledge_point_by_topic()` L34: 认知复杂度: 15
- 🏗️ `match_knowledge_point_by_topic()` L34: 中等嵌套: 3
...
### 59. backend\courses\teacher_course_support.py

**糟糕指数: 3.58**

> 行数: 386 总计, 311 代码, 0 注释 | 函数: 30 | 类: 1
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `create_teacher_course` | L70-110 | 41 | 9 | 3 | 3 | ✓ |
| `resolve_publish_class` | L113-126 | 14 | 5 | 1 | 2 | ✓ |
| `update_course_config` | L350-364 | 15 | 5 | 1 | 2 | ✓ |
| `build_course_detail_payload` | L186-198 | 13 | 4 | 0 | 1 | ✓ |
| `update_teacher_course` | L201-208 | 8 | 4 | 2 | 2 | ✓ |
| `delete_teacher_course` | L249-260 | 12 | 4 | 1 | 2 | ✓ |
| `update_course_settings_for_user` | L375-385 | 11 | 4 | 1 | 3 | ✓ |
| `build_course_search_item` | L58-67 | 10 | 3 | 0 | 1 | ✓ |
| `bootstrap_course_archive` | L129-152 | 24 | 3 | 1 | 3 | ✓ |
| `publish_course_to_class` | L155-168 | 14 | 3 | 1 | 3 | ✓ |
| `cleanup_course_archive` | L171-178 | 8 | 3 | 1 | 1 | ✓ |
| `apply_legacy_course_fields` | L211-219 | 9 | 3 | 2 | 2 | ✓ |
| `can_delete_course` | L239-241 | 3 | 3 | 0 | 2 | ✓ |
| `get_owned_course` | L263-270 | 8 | 3 | 1 | 3 | ✓ |
| `upload_teacher_course_cover` | L273-282 | 10 | 3 | 1 | 3 | ✓ |
| `save_course_cover` | L285-294 | 10 | 3 | 1 | 3 | ✓ |
| `write_course_cover_file` | L297-306 | 10 | 3 | 2 | 2 | ✓ |
| `build_course_statistics_for_user` | L327-332 | 6 | 3 | 1 | 2 | ✓ |
| `build_course_settings_for_user` | L367-372 | 6 | 3 | 1 | 2 | ✓ |
| `build_course_search_payload` | L30-45 | 16 | 2 | 1 | 1 | ✓ |
| `parse_course_pagination` | L48-55 | 8 | 2 | 1 | 1 | ✓ |
| `can_access_owned_course` | L244-246 | 3 | 2 | 0 | 2 | ✓ |
| `merged_course_config` | L341-347 | 7 | 2 | 1 | 1 | ✓ |
| `chunks` | L26-27 | 2 | 1 | 0 | 1 | ✓ |
| `get_teacher_course` | L181-183 | 3 | 1 | 0 | 1 | ✓ |
| `build_my_created_courses_payload` | L222-225 | 4 | 1 | 0 | 1 | ✓ |
| `build_my_course_item` | L228-236 | 9 | 1 | 0 | 1 | ✓ |
| `build_course_statistics_payload` | L309-318 | 10 | 1 | 0 | 1 | ✓ |
| `course_student_ids` | L321-324 | 4 | 1 | 0 | 1 | ✓ |
| `build_course_settings_payload` | L335-338 | 4 | 1 | 0 | 1 | ✓ |

**全部问题 (5)**

- 🔄 `create_teacher_course()` L70: 认知复杂度: 15
- 🏗️ `create_teacher_course()` L70: 中等嵌套: 3
- ❌ L257: 未处理的易出错调用
- ❌ L303: 未处理的易出错调用
- ❌ L305: 未处理的易出错调用
...
### 60. backend\ai_services\services\path_service.py
...
### 61. backend\tools\exam_sets_support.py

**糟糕指数: 3.44**

> 行数: 367 总计, 311 代码, 2 注释 | 函数: 17 | 类: 2
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `bind_question_knowledge_points` | L122-146 | 25 | 5 | 2 | 4 | ✓ |
| `iter_excel_rows` | L163-182 | 20 | 5 | 2 | 3 | ✓ |
| `extract_row_content` | L86-97 | 12 | 4 | 2 | 2 | ✓ |
| `match_row_question` | L244-266 | 23 | 4 | 1 | 3 | ✓ |
| `resolve_content_columns` | L67-83 | 17 | 3 | 1 | 1 | ✓ |
| `match_question` | L227-241 | 15 | 3 | 1 | 2 | ✓ |
| `load_matched_questions` | L269-286 | 18 | 3 | 2 | 3 | ✓ |
| `collect_question_knowledge_point_names` | L289-299 | 11 | 3 | 2 | 1 | ✓ |
| `create_exam_set` | L330-366 | 37 | 3 | 1 | 4 | ✓ |
| `load_pandas_module` | L45-55 | 11 | 2 | 1 | 0 | ✓ |
| `resolve_knowledge_point` | L100-119 | 20 | 2 | 1 | 3 | ✓ |
| `read_excel_sheet` | L149-160 | 12 | 2 | 1 | 3 | ✓ |
| `build_question_lookup` | L185-204 | 20 | 2 | 1 | 1 | ✓ |
| `open_excel_file` | L302-313 | 12 | 2 | 1 | 2 | ✓ |
| `normalize_question_content` | L58-64 | 7 | 1 | 0 | 1 | ✓ |
| `build_import_context` | L207-224 | 18 | 1 | 0 | 2 | ✓ |
| `question_set_exists` | L316-327 | 12 | 1 | 0 | 2 | ✓ |
...
### 62. backend\ai_services\services\kt_prediction_modes.py
...
### 63. backend\users\profile_generation.py
...
### 64. backend\tools\question_import_text.py

**糟糕指数: 3.41**

> 行数: 70 总计, 55 代码, 2 注释 | 函数: 3 | 类: 0

**问题**: 🔄 复杂度问题: 1, 🏗️ 结构问题: 1, 📝 注释问题: 1

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `strip_import_answer_payload` | L30-48 | 19 | 7 | 3 | 1 | ✓ |
| `clean_question_options` | L51-69 | 19 | 6 | 2 | 1 | ✓ |
| `strip_import_text` | L20-27 | 8 | 2 | 1 | 1 | ✓ |

**全部问题 (2)**

- 🔄 `strip_import_answer_payload()` L30: 认知复杂度: 13
- 🏗️ `strip_import_answer_payload()` L30: 中等嵌套: 3
...
### 66. backend\courses\admin_statistics_views.py
...
### 67. backend\ai_services\test_web_search.py
...
### 68. backend\ai_services\test_student_rag_runtime.py
...
### 69. backend\ai_services\test_student_rag_context.py
...
### 70. backend\ai_services\test_student_rag_base.py
...
### 71. backend\ai_services\test_student_ai_multicourse.py
...
### 72. backend\tools\api_regression_student_learning.py
...
### 73. backend\ai_services\services\path_generation_nodes.py

**糟糕指数: 3.27**

> 行数: 342 总计, 301 代码, 0 注释 | 函数: 14 | 类: 1
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `expand_linked_point_ids` | L67-90 | 24 | 7 | 3 | 5 | ✓ |
| `fill_unlinked_point_ids` | L93-108 | 16 | 4 | 2 | 3 | ✓ |
| `attach_resources_to_created_nodes` | L331-341 | 11 | 4 | 2 | 2 | ✓ |
| `build_linked_pending_batch` | L24-49 | 26 | 3 | 1 | 5 | ✓ |
| `build_pending_nodes` | L145-185 | 41 | 3 | 1 | 8 | ✓ |
| `build_study_title` | L214-218 | 5 | 3 | 1 | 3 | ✓ |
| `build_study_suggestion` | L221-225 | 5 | 3 | 1 | 3 | ✓ |
| `build_completed_nodes` | L111-142 | 32 | 2 | 1 | 4 | ✓ |
| `build_test_node` | L228-252 | 25 | 2 | 1 | 3 | ✓ |
| `build_test_title` | L255-259 | 5 | 2 | 1 | 1 | ✓ |
| `assemble_generation_plan` | L303-328 | 26 | 2 | 1 | 7 | ✓ |
| `order_pending_points` | L52-64 | 13 | 1 | 0 | 2 | ✓ |
| `build_study_node` | L188-211 | 24 | 1 | 0 | 5 | ✓ |
| `build_generation_plan` | L262-300 | 39 | 1 | 0 | 8 | ✓ |

**全部问题 (6)**

- 🔄 `expand_linked_point_ids()` L67: 认知复杂度: 13
- 📏 `build_pending_nodes()` L145: 8 参数数量
- 📏 `build_generation_plan()` L262: 8 参数数量
- 📏 `assemble_generation_plan()` L303: 7 参数数量
- 🏗️ `expand_linked_point_ids()` L67: 中等嵌套: 3
- ❌ L60: 未处理的易出错调用
...
### 74. backend\common\defense_demo_assessment_support.py
...
### 75. backend\users\admin_user_management_support.py

**糟糕指数: 3.11**

> 行数: 335 总计, 271 代码, 0 注释 | 函数: 24 | 类: 1
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `build_admin_user_detail_payload` | L95-109 | 15 | 7 | 0 | 1 | ✓ |
| `build_user_export_row` | L305-317 | 13 | 7 | 0 | 1 | ✓ |
| `update_admin_user` | L135-149 | 15 | 6 | 2 | 2 | ✓ |
| `read_user_excel_rows` | L223-242 | 20 | 6 | 2 | 1 | ✓ |
| `filtered_admin_users` | L53-73 | 21 | 5 | 1 | 1 | ✓ |
| `create_admin_user` | L112-132 | 21 | 5 | 1 | 1 | ✓ |
| `import_admin_users` | L245-256 | 12 | 5 | 3 | 1 | ✓ |
| `create_user_from_import_row` | L259-278 | 20 | 5 | 1 | 2 | ✓ |
| `build_admin_user_list_item` | L76-87 | 12 | 4 | 0 | 1 | ✓ |
| `read_user_import_rows` | L204-214 | 11 | 4 | 2 | 1 | ✓ |
| `reset_admin_user_password` | L159-169 | 11 | 3 | 1 | 2 | ✓ |
| `normalize_delete_user_ids` | L193-201 | 9 | 3 | 1 | 2 | ✓ |
| `first_row_value` | L281-287 | 7 | 3 | 2 | 2 | ✓ |
| `build_user_export_response` | L290-302 | 13 | 3 | 1 | 1 | ✓ |
| `set_admin_user_active` | L178-183 | 6 | 2 | 0 | 2 | ✓ |
| `read` | L36-37 | 2 | 1 | 0 | 1 | ✓ |
| `build_admin_user_list_payload` | L40-50 | 11 | 1 | 0 | 3 | ✓ |
| `get_admin_user` | L90-92 | 3 | 1 | 0 | 1 | ✓ |
| `delete_admin_user` | L152-156 | 5 | 1 | 0 | 1 | ✓ |
| `generate_random_password` | L172-175 | 4 | 1 | 0 | 1 | ✓ |
| `delete_admin_users` | L186-190 | 5 | 1 | 0 | 2 | ✓ |
| `read_user_csv_rows` | L217-220 | 4 | 1 | 0 | 1 | ✓ |
| `build_user_import_template_response` | L320-326 | 7 | 1 | 0 | 0 | ✓ |
| `build_csv_response` | L329-334 | 6 | 1 | 0 | 1 | ✓ |

**全部问题 (6)**

- 🏗️ `import_admin_users()` L245: 中等嵌套: 3
- ❌ L36: 未处理的易出错调用
- ❌ L155: 未处理的易出错调用
- ❌ L189: 忽略了错误返回值
- ❌ L242: 未处理的易出错调用
...
### 76. backend\knowledge\serializers.py
...
### 78. backend\platform_ai\rag\student_index_mixin.py
...
### 80. backend\tools\resources.py

**糟糕指数: 3.04**

> 行数: 175 总计, 139 代码, 0 注释 | 函数: 9 | 类: 1

**问题**: ⚠️ 其他问题: 1, 🏗️ 结构问题: 1, ❌ 错误处理问题: 2, 📝 注释问题: 1

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `build_resource_row` | L72-87 | 16 | 6 | 1 | 2 | ✓ |
| `import_resources_json` | L29-55 | 27 | 5 | 2 | 4 | ✓ |
| `parse_resource_rows` | L58-69 | 12 | 5 | 3 | 1 | ✓ |
| `delete_link_resources` | L136-166 | 31 | 4 | 1 | 2 | ✓ |
| `create_resource_rows` | L90-100 | 11 | 3 | 2 | 3 | ✓ |
| `bind_resource_points` | L124-133 | 10 | 3 | 2 | 3 | ✓ |
| `preview_link_resources` | L169-174 | 6 | 3 | 1 | 2 | ✓ |
| `should_skip_existing_resource` | L103-107 | 5 | 2 | 1 | 3 | ✓ |
| `create_resource` | L110-121 | 12 | 1 | 0 | 2 | ✓ |

**全部问题 (3)**

- 🏗️ `parse_resource_rows()` L58: 中等嵌套: 3
- ❌ L51: 忽略了错误返回值
- ❌ L165: 忽略了错误返回值
...
### 81. backend\tools\kt_synthetic_profile.py
...
### 82. backend\learning\stage_test_standard_submission.py

**糟糕指数: 2.96**

> 行数: 196 总计, 171 代码, 0 注释 | 函数: 7 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `update_standard_node_status` | L60-73 | 14 | 5 | 1 | 2 | ✓ |
| `fallback_mastery_update` | L161-188 | 28 | 5 | 3 | 3 | ✓ |
| `submit_standard_stage_test` | L22-57 | 36 | 3 | 1 | 6 | ✓ |
| `apply_stage_kt_predictions` | L134-158 | 25 | 3 | 2 | 3 | ✓ |
| `update_mastery_from_kt_or_fallback` | L76-94 | 19 | 2 | 1 | 3 | ✓ |
| `predict_stage_mastery` | L97-131 | 35 | 2 | 0 | 3 | ✓ |
| `refresh_learning_path` | L191-195 | 5 | 1 | 0 | 2 | ✓ |

**全部问题 (3)**

- 📏 `submit_standard_stage_test()` L22: 6 参数数量
- 📋 `apply_stage_kt_predictions()` L134: 重复模式: apply_stage_kt_predictions, fallback_mastery_update
- 🏗️ `fallback_mastery_update()` L161: 中等嵌套: 3
...
### 83. backend\platform_ai\rag\runtime_graph_query_support.py
...
### 85. backend\knowledge\teacher_helpers.py
...
### 86. backend\assessments\habit_views.py
...
### 87. backend\assessments\status_profile_views.py
...
### 88. backend\courses\teacher_invitation_views.py
...
### 89. backend\knowledge\resource_views.py
...
### 90. backend\knowledge\services.py
...
### 91. backend\courses\teacher_student_views.py
...
### 92. backend\learning\path_views.py
...
### 93. backend\users\admin_profile_views.py
...
### 95. backend\wisdom_edu_api\settings_ai.py
...
### 96. backend\platform_ai\rag\student_point_path_mixin.py
...
### 97. backend\learning\dashboard_views.py
...
### 99. backend\ai_services\student_ai_chat_views.py
...
### 100. backend\assessments\knowledge_generation.py
...
### 101. backend\logs\descriptions.py
...
### 102. backend\tools\question_import_answers.py

**糟糕指数: 1.04**

> 行数: 65 总计, 50 代码, 2 注释 | 函数: 3 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `build_excel_answer` | L31-44 | 14 | 9 | 2 | 2 | ✓ |
| `normalize_true_false_options` | L47-64 | 18 | 6 | 2 | 2 | ✓ |
| `normalize_question_answer` | L21-28 | 8 | 4 | 1 | 1 | ✓ |

**全部问题 (1)**

- 🔄 `build_excel_answer()` L31: 认知复杂度: 13
...
### 103. backend\ai_services\student_rag_views.py
...
### 104. backend\courses\teacher_announcement_views.py
...
### 105. backend\users\student_profile_support.py
...
### 106. backend\users\admin_activation_views.py
...
### 107. backend\tools\rebuild_demo_support.py
...
### 108. backend\common\question_options.py
...
### 109. backend\platform_ai\rag\runtime_materialization_mixin.py
...
### 111. backend\exams\teacher_question_views.py
...
### 112. backend\exams\student_feedback_views.py
...
### 113. backend\ai_services\consumers.py
...
### 114. backend\exams\student_submission_views.py
...
### 115. backend\models\MEFKT\attribute.py
...
### 116. backend\platform_ai\llm\agent.py
...
### 117. backend\tools\db_demo_preset_support.py
...
### 118. backend\assessments\knowledge_generation_support.py
...
### 119. backend\common\defense_demo_assessment_questions.py
...
### 120. backend\tools\question_import_json.py

**糟糕指数: 0.69**

> 行数: 63 总计, 51 代码, 2 注释 | 函数: 3 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `build_json_question_payload` | L45-62 | 18 | 9 | 1 | 1 | ✓ |
| `load_question_json_source` | L28-42 | 15 | 5 | 2 | 1 | ✓ |
| `validate_question_json_payload` | L21-25 | 5 | 2 | 1 | 1 | ✓ |
...
### 121. frontend\scripts\browser-audit\args.mjs
...
### 122. backend\learning\stage_test_feedback.py
...
### 123. backend\knowledge\teacher_resource_support.py

**糟糕指数: 0.59**

> 行数: 204 总计, 173 代码, 0 注释 | 函数: 12 | 类: 1
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `update_resource_from_payload` | L169-188 | 20 | 9 | 1 | 2 | ✓ |
| `resource_list_payload` | L44-65 | 22 | 7 | 0 | 1 | ✓ |
| `parse_resource_points` | L121-132 | 12 | 6 | 2 | 1 | ✓ |
| `filtered_teacher_resources` | L29-41 | 13 | 5 | 1 | 2 | ✓ |
| `resource_file_display` | L68-77 | 10 | 5 | 2 | 1 | ✓ |
| `resource_detail_payload` | L87-102 | 16 | 5 | 0 | 1 | ✓ |
| `parse_resource_write_payload` | L105-118 | 14 | 4 | 0 | 2 | ✓ |
| `parse_optional_int` | L135-142 | 8 | 4 | 1 | 1 | ✓ |
| `resource_create_result` | L197-203 | 7 | 4 | 0 | 1 | ✓ |
| `create_resource_from_payload` | L145-166 | 22 | 3 | 0 | 4 | ✓ |
| `resource_duration_display` | L80-84 | 5 | 2 | 1 | 1 | ✓ |
| `replace_resource_points` | L191-194 | 4 | 2 | 1 | 2 | ✓ |
...
### 124. backend\knowledge\teacher_relation_views.py
...
### 125. backend\exams\student_helpers.py
...
### 126. backend\common\defense_demo_progress.py
...
### 127. backend\platform_ai\rag\student_resource_mixin.py
...
### 128. backend\ai_services\services\kt_service.py

**糟糕指数: 0.50**

> 行数: 278 总计, 239 代码, 0 注释 | 函数: 8 | 类: 1
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `__init__` | L64-123 | 60 | 8 | 1 | 6 | ✓ |
| `is_available` | L192-220 | 29 | 6 | 2 | 1 | ✓ |
| `_resolve_backend_path` | L40-50 | 11 | 4 | 1 | 1 | ✓ |
| `_resolve_enabled_models` | L125-146 | 22 | 4 | 2 | 2 | ✓ |
| `_normalize_weights` | L167-189 | 23 | 4 | 2 | 1 | ✓ |
| `get_model_info` | L222-256 | 35 | 4 | 1 | 1 | ✓ |
| `_load_fusion_weights` | L148-165 | 18 | 3 | 2 | 1 | ✓ |
| `_load_runtime_info` | L258-267 | 10 | 3 | 2 | 2 | ✓ |
...
- ❌ L235: 未处理的易出错调用
- ❌ L249: 未处理的易出错调用
- 🏷️ `_resolve_backend_path()` L40: "_resolve_backend_path" - snake_case
- 🏷️ `__init__()` L64: "__init__" - snake_case
- 🏷️ `_resolve_enabled_models()` L125: "_resolve_enabled_models" - snake_case
- 🏷️ `_load_fusion_weights()` L148: "_load_fusion_weights" - snake_case
- 🏷️ `_normalize_weights()` L167: "_normalize_weights" - snake_case
- 🏷️ `_load_runtime_info()` L258: "_load_runtime_info" - snake_case
...
### 129. backend\tools\exam_sets.py

**糟糕指数: 0.44**

> 行数: 177 总计, 146 代码, 2 注释 | 函数: 8 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `import_exam_sets` | L137-176 | 40 | 7 | 2 | 4 | ✓ |
| `import_single_exam_file` | L82-113 | 32 | 6 | 1 | 3 | ✓ |
| `build_exam_title` | L70-79 | 10 | 4 | 0 | 1 | ✓ |
| `collect_import_files` | L53-67 | 15 | 3 | 1 | 1 | ✓ |
| `resolve_homework_path` | L33-41 | 9 | 2 | 1 | 1 | ✓ |
| `print_dry_run` | L116-124 | 9 | 2 | 1 | 1 | ✓ |
| `collect_excel_files` | L44-50 | 7 | 1 | 0 | 1 | ✓ |
| `clear_existing_question_sets` | L127-134 | 8 | 1 | 0 | 1 | ✓ |
...
### 130. backend\tools\api_regression_teacher.py
...
### 132. backend\knowledge\map_support.py

**糟糕指数: 0.44**

> 行数: 410 总计, 372 代码, 0 注释 | 函数: 16 | 类: 0

**问题**: ⚠️ 其他问题: 2, ❌ 错误处理问题: 32, 📝 注释问题: 1, 🏷️ 命名问题: 3

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `build_postgresql_knowledge_map_payload` | L26-66 | 41 | 8 | 0 | 2 | ✓ |
| `build_mastery_payload` | L325-363 | 39 | 6 | 0 | 2 | ✓ |
| `_resolve_resource_url` | L378-393 | 16 | 6 | 2 | 2 | ✓ |
| `build_point_detail_payload` | L181-212 | 32 | 5 | 0 | 7 | ✓ |
| `build_mastery_lookup` | L12-23 | 12 | 4 | 2 | 2 | ✓ |
| `build_resource_payload` | L156-178 | 23 | 4 | 2 | 2 | ✓ |
| `build_neo4j_knowledge_map_payload` | L69-108 | 40 | 3 | 1 | 3 | ✓ |
| `build_knowledge_map_response_payload` | L111-138 | 28 | 3 | 0 | 4 | ✓ |
| `build_postgresql_points_payload` | L294-322 | 29 | 3 | 1 | 3 | ✓ |
| `_mapping_records` | L371-375 | 5 | 3 | 1 | 1 | ✓ |
| `build_neo4j_points_payload` | L265-291 | 27 | 2 | 1 | 2 | ✓ |
| `build_postgresql_point_relations` | L141-153 | 13 | 1 | 0 | 1 | ✓ |
| `build_neo4j_relations_payload` | L215-237 | 23 | 1 | 0 | 2 | ✓ |
| `build_postgresql_relations_payload` | L240-262 | 23 | 1 | 0 | 1 | ✓ |
| `normalize_relation_records` | L366-368 | 3 | 1 | 0 | 1 | ✓ |
| `_build_collection_payload` | L396-409 | 14 | 1 | 0 | 4 | ✓ |

**全部问题 (36)**

- 📏 `build_point_detail_payload()` L181: 7 参数数量
- ❌ L41: 未处理的易出错调用
- ❌ L77: 未处理的易出错调用
- ❌ L83: 未处理的易出错调用
- ❌ L84: 未处理的易出错调用
...
- ❌ L281: 未处理的易出错调用
- ❌ L282: 未处理的易出错调用
- 🏷️ `_mapping_records()` L371: "_mapping_records" - snake_case
- 🏷️ `_resolve_resource_url()` L378: "_resolve_resource_url" - snake_case
- 🏷️ `_build_collection_payload()` L396: "_build_collection_payload" - snake_case

**详情**:
- 循环复杂度: 平均: 3.3, 最大: 8
- 认知复杂度: 平均: 4.5, 最大: 10
- 嵌套深度: 平均: 0.6, 最大: 2
- 函数长度: 平均: 23.0 行, 最大: 41 行
- 文件长度: 372 代码量 (410 总计)
- 参数数量: 平均: 2.4, 最大: 7
- 代码重复: 0.0% 重复 (0/16)
- 结构分析: 0 个结构问题
- 错误处理: 32/33 个错误被忽略 (97.0%)
- 注释比例: 0.0% (0/372)
- 命名规范: 发现 3 个违规

### 133. backend\exams\student_exam_support.py

**糟糕指数: 0.44**

> 行数: 233 总计, 193 代码, 0 注释 | 函数: 16 | 类: 1
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `serialize_exam_summary` | L135-154 | 20 | 9 | 0 | 2 | ✓ |
| `resolve_exam_detail_access_error` | L172-181 | 10 | 6 | 1 | 2 | ✓ |
| `normalize_query_value` | L48-52 | 5 | 3 | 1 | 1 | ✓ |
| `build_visible_exam_queryset` | L71-79 | 9 | 3 | 1 | 2 | ✓ |
| `apply_exam_filters` | L82-88 | 7 | 3 | 1 | 2 | ✓ |
| `resolve_submission_score` | L157-161 | 5 | 3 | 1 | 1 | ✓ |
| `apply_student_exam_visibility` | L91-102 | 12 | 2 | 1 | 3 | ✓ |
| `build_submission_map` | L124-132 | 9 | 2 | 1 | 2 | ✓ |
| `get_published_exam` | L164-169 | 6 | 2 | 1 | 1 | ✓ |
| `offset` | L28-30 | 3 | 1 | 0 | 1 | ✓ |
| `limit` | L33-35 | 3 | 1 | 0 | 1 | ✓ |
| `parse_exam_list_params` | L38-45 | 8 | 1 | 0 | 1 | ✓ |
| `build_exam_list_payload` | L55-68 | 14 | 1 | 0 | 2 | ✓ |
| `load_student_exam_scope` | L105-121 | 17 | 1 | 0 | 1 | ✓ |
| `build_exam_detail_payload` | L184-203 | 20 | 1 | 0 | 1 | ✓ |
| `serialize_exam_question` | L206-218 | 13 | 1 | 0 | 2 | ✓ |
...
### 134. backend\common\responses.py
...
### 135. backend\assessments\serializers.py
...
### 136. backend\platform_ai\rag\student_utils.py
...
### 137. backend\platform_ai\rag\resource_utils.py
...
### 138. frontend\src\views\student\useLearningPath.js
...
### 139. frontend\src\views\student\feedbackReportModels.js
...
### 140. backend\users\auth_support.py

**糟糕指数: 0.37**

> 行数: 365 总计, 292 代码, 0 注释 | 函数: 25 | 类: 1
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `validate_userinfo_field` | L286-294 | 9 | 7 | 1 | 3 | ✓ |
| `registration_duplicate_error` | L67-77 | 11 | 6 | 1 | 2 | ✓ |
| `authenticate_user_login` | L112-129 | 18 | 6 | 1 | 2 | ✓ |
| `build_enrollment_class_payload` | L189-207 | 19 | 6 | 0 | 1 | ✓ |
| `update_userinfo_payload` | L251-276 | 26 | 6 | 2 | 3 | ✓ |
| `validate_activation_code` | L96-109 | 14 | 5 | 1 | 2 | ✓ |
| `validate_username_value` | L315-326 | 12 | 5 | 1 | 2 | ✓ |
| `change_user_password` | L340-353 | 14 | 5 | 1 | 2 | ✓ |
| `register_user` | L49-64 | 16 | 4 | 1 | 1 | ✓ |
| `register_privileged_user` | L80-93 | 14 | 4 | 1 | 3 | ✓ |
| `build_user_learning_context` | L161-177 | 17 | 4 | 2 | 1 | ✓ |
| `get_avatar_url` | L38-46 | 9 | 3 | 1 | 1 | ✓ |
| `resolve_class_course` | L210-216 | 7 | 3 | 1 | 1 | ✓ |
| `build_teaching_class_payload` | L224-236 | 13 | 3 | 0 | 1 | ✓ |
| `append_unique_course` | L239-248 | 10 | 3 | 1 | 4 | ✓ |
| `normalize_userinfo_value` | L279-283 | 5 | 3 | 1 | 2 | ✓ |
| `validate_phone_value` | L297-303 | 7 | 3 | 1 | 2 | ✓ |
| `validate_email_value` | L306-312 | 7 | 3 | 1 | 2 | ✓ |
| `refresh_access_token` | L329-337 | 9 | 3 | 1 | 1 | ✓ |
| `blacklist_refresh_token` | L356-364 | 9 | 3 | 1 | 1 | ✓ |
| `get_authenticated_user` | L33-35 | 3 | 1 | 0 | 1 | ✓ |
| `build_auth_payload` | L132-141 | 10 | 1 | 0 | 1 | ✓ |
| `build_userinfo_payload` | L144-158 | 15 | 1 | 0 | 1 | ✓ |
| `user_enrollments` | L180-186 | 7 | 1 | 0 | 1 | ✓ |
| `teaching_classes` | L219-221 | 3 | 1 | 0 | 1 | ✓ |

**全部问题 (2)**

- 📋 `register_privileged_user()` L80: 重复模式: register_privileged_user, resolve_class_course
- 📋 `validate_phone_value()` L297: 重复模式: validate_phone_value, validate_email_value, refresh_access_token
...
### 141. frontend\src\views\teacher\useTeacherQuestionList.js
...
### 142. frontend\src\views\teacher\useTeacherResourceManage.js
...
### 145. backend\tools\excel_templates.py
...
### 146. backend\tools\api_regression_admin_support.py
...
### 147. backend\tools\api_regression.py
...
### 148. backend\learning\serializers.py
...
### 150. backend\common\defense_demo_public.py
...
### 151. backend\common\defense_demo_path.py
...
### 152. backend\common\defense_demo_content.py
...
### 153. backend\platform_ai\rag\runtime_graph_query_mixin.py
...
### 154. backend\application\teacher\contracts.py
...
### 155. backend\ai_services\services\student_graph_rag_support.py

**糟糕指数: 0.30**

> 行数: 457 总计, 378 代码, 0 注释 | 函数: 28 | 类: 1

**问题**: ⚠️ 其他问题: 2, ❌ 错误处理问题: 7, 📝 注释问题: 1

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `match_points_by_query_text` | L74-89 | 16 | 6 | 2 | 3 | ✓ |
| `extract_matched_point_ids` | L131-144 | 14 | 6 | 2 | 1 | ✓ |
| `build_graph_answer_payload` | L177-197 | 21 | 6 | 0 | 3 | ✓ |
| `answer_explicit_or_structure_question` | L375-402 | 28 | 6 | 1 | 3 | ✓ |
| `coerce_positive_int` | L147-154 | 8 | 5 | 1 | 1 | ✓ |
| `build_search_item` | L200-218 | 19 | 5 | 0 | 2 | ✓ |
| `answer_graph_question` | L340-365 | 26 | 5 | 2 | 4 | ✓ |
| `unique_ranked_points` | L92-103 | 12 | 4 | 2 | 2 | ✓ |
| `resolve_point_from_ids` | L106-120 | 15 | 4 | 2 | 2 | ✓ |
| `extract_first_search_point_id` | L165-174 | 10 | 4 | 1 | 1 | ✓ |
| `search_graph_points` | L245-258 | 14 | 4 | 1 | 4 | ✓ |
| `search_with_runtime` | L261-274 | 14 | 4 | 1 | 4 | ✓ |
| `build_runtime_matched_points` | L277-296 | 20 | 4 | 2 | 3 | ✓ |
| `has_course_rag_result` | L157-162 | 6 | 3 | 1 | 1 | ✓ |
| `neo4j_relation_names` | L221-231 | 11 | 3 | 1 | 1 | ✓ |
| `relation_point_names` | L234-242 | 9 | 3 | 1 | 1 | ✓ |
| `build_runtime_match_item` | L299-308 | 10 | 3 | 1 | 3 | ✓ |
| `answer_course_or_llm_fallback` | L420-433 | 14 | 3 | 1 | 4 | ✓ |
| `extract_text_list` | L123-128 | 6 | 2 | 1 | 2 | ✓ |
| `search_with_database_keyword` | L320-337 | 18 | 2 | 0 | 4 | ✓ |
| `point_from_explicit_id` | L368-372 | 5 | 2 | 1 | 2 | ✓ |
| `point_from_search` | L405-411 | 7 | 2 | 1 | 3 | ✓ |
| `build_llm_fallback` | L436-456 | 21 | 2 | 1 | 2 | ✓ |
| `to_dict` | L49-59 | 11 | 1 | 0 | 1 | ✓ |
| `normalize_match_text` | L62-65 | 4 | 1 | 0 | 1 | ✓ |
| `is_graph_structure_question` | L68-71 | 4 | 1 | 0 | 1 | ✓ |
| `build_name_match_response` | L311-317 | 7 | 1 | 0 | 3 | ✓ |
| `answer_focused_point_question` | L414-417 | 4 | 1 | 0 | 4 | ✓ |
...
### 156. backend\ai_services\services\mefkt_legacy_runtime.py
...
### 157. backend\ai_services\services\llm_profile_path_support.py
...
### 159. backend\courses\teacher_course_helpers.py
...
### 160. frontend\src\views\student\useExamTaking.js
...
### 161. frontend\src\views\student\profileModels.js
...
### 163. backend\users\auth_password_views.py
...
### 164. backend\tools\kt_synthetic.py
...
### 165. backend\tools\course_cleanup.py
...
### 167. backend\learning\stage_test_evaluation.py

**糟糕指数: 0.15**

> 行数: 217 总计, 194 代码, 0 注释 | 函数: 8 | 类: 0

**问题**: ⚠️ 其他问题: 2, ❌ 错误处理问题: 11, 📝 注释问题: 1

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `mistake_detail` | L199-216 | 18 | 7 | 0 | 2 | ✓ |
| `build_single_question_detail` | L126-184 | 59 | 4 | 0 | 5 | ✓ |
| `question_ids_from_answers` | L68-76 | 9 | 3 | 2 | 1 | ✓ |
| `evaluate_stage_test` | L26-65 | 40 | 2 | 0 | 3 | ✓ |
| `build_question_details` | L103-123 | 21 | 2 | 1 | 5 | ✓ |
| `question_map_for_node` | L79-87 | 9 | 1 | 0 | 2 | ✓ |
| `grade_stage_questions` | L90-100 | 11 | 1 | 0 | 2 | ✓ |
| `build_detailed_mistakes` | L187-196 | 10 | 1 | 0 | 2 | ✓ |

**全部问题 (12)**

- 📏 `build_single_question_detail()` L126: 59 代码量
- ❌ L149: 未处理的易出错调用
- ❌ L176: 未处理的易出错调用
- ❌ L182: 未处理的易出错调用
- ❌ L183: 未处理的易出错调用
...
### 168. backend\learning\path_adjustment.py
...
### 169. backend\exams\teacher_result_views.py
...
### 170. backend\exams\teacher_helpers.py
...
### 171. backend\exams\student_initial_assessment_views.py
...
### 172. backend\exams\student_artifact_views.py
...
### 173. backend\exams\serializers.py
...
### 174. backend\exams\report_service_support.py
...
### 176. backend\assessments\assessment_helpers.py
...
### 177. backend\ai_services\auth.py
...
### 178. backend\platform_ai\rag\student_answer_support.py
...
### 179. backend\platform_ai\llm\agent_graphrag.py

**糟糕指数: 0.15**

> 行数: 267 总计, 223 代码, 0 注释 | 函数: 16 | 类: 0

**问题**: ⚠️ 其他问题: 1, ❌ 错误处理问题: 5, 📝 注释问题: 1

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `trim_graph_sources` | L13-24 | 12 | 5 | 2 | 2 | ✓ |
| `build_point_graphrag_payload` | L44-54 | 11 | 4 | 1 | 2 | ✓ |
| `build_lookup_course_context_payload` | L210-224 | 15 | 4 | 1 | 2 | ✓ |
| `build_point_context_payload` | L236-254 | 19 | 4 | 1 | 3 | ✓ |
| `normalize_graph_source` | L27-36 | 10 | 3 | 0 | 1 | ✓ |
| `fetch_point_support_payload` | L57-74 | 18 | 3 | 1 | 2 | ✓ |
| `resolve_point_name` | L107-112 | 6 | 3 | 1 | 2 | ✓ |
| `query_course_graph` | L136-163 | 28 | 3 | 1 | 5 | ✓ |
| `clean_positive_ids` | L203-207 | 5 | 3 | 1 | 1 | ✓ |
| `build_course_graphrag_payload` | L77-104 | 28 | 2 | 1 | 4 | ✓ |
| `clean_string_list` | L196-200 | 5 | 2 | 1 | 1 | ✓ |
| `clean_source_field` | L39-41 | 3 | 1 | 0 | 2 | ✓ |
| `empty_course_graphrag_payload` | L115-133 | 19 | 1 | 0 | 3 | ✓ |
| `normalize_course_graphrag_payload` | L166-188 | 23 | 1 | 0 | 6 | ✓ |
| `clean_payload_text` | L191-193 | 3 | 1 | 0 | 2 | ✓ |
| `build_missing_point_payload` | L227-233 | 7 | 1 | 0 | 1 | ✓ |

**全部问题 (6)**

- 📏 `normalize_course_graphrag_payload()` L166: 6 参数数量
- ❌ L48: 未处理的易出错调用
- ❌ L52: 未处理的易出错调用
- ❌ L182: 未处理的易出错调用
- ❌ L183: 未处理的易出错调用
...
### 180. backend\ai_services\services\mefkt_runtime_graph.py

**糟糕指数: 0.15**

> 行数: 132 总计, 114 代码, 2 注释 | 函数: 5 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `pairwise_graph_weight` | L10-32 | 23 | 7 | 0 | 7 | ✓ |
| `compute_related_bridge_score` | L35-46 | 12 | 3 | 1 | 4 | ✓ |
| `accumulate_left_question_edges` | L86-120 | 35 | 3 | 2 | 7 | ✓ |
| `build_graph_statistics` | L49-83 | 35 | 2 | 1 | 3 | ✓ |
| `build_two_hop_density` | L123-131 | 9 | 2 | 1 | 3 | ✓ |

**全部问题 (2)**

- 📏 `pairwise_graph_weight()` L10: 7 参数数量
- 📏 `accumulate_left_question_edges()` L86: 7 参数数量
...
### 181. frontend\src\api\errors.ts
...
### 182. backend\tools\mefkt_training_support.py
...
### 183. backend\learning\stage_test_selection.py
...
### 184. backend\exams\student_initial_assessment_support.py
...
### 185. backend\exams\score_policy.py
...
### 186. backend\common\logging_utils.py
...
### 187. backend\assessments\ability_views.py
...
### 188. frontend\src\stores\course.ts
...
### 189. frontend\src\api\backend.ts
...
### 190. backend\platform_ai\rag\corpus_utils.py
...
### 191. backend\models\MEFKT\sequence.py
...
### 192. backend\models\MEFKT\graph.py
...
### 193. backend\platform_ai\llm\agent_json.py

**糟糕指数: 0.07**

> 行数: 54 总计, 40 代码, 0 注释 | 函数: 4 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `parse_json_payload` | L12-18 | 7 | 4 | 2 | 1 | ✓ |
| `extract_inline_json_candidate` | L30-36 | 7 | 3 | 1 | 1 | ✓ |
| `parse_json_candidate` | L39-45 | 7 | 3 | 1 | 1 | ✓ |
| `iter_json_candidates` | L21-27 | 7 | 2 | 1 | 1 | ✓ |
...
### 194. backend\ai_services\services\path_generation_support.py

**糟糕指数: 0.07**

> 行数: 157 总计, 134 代码, 0 注释 | 函数: 4 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `sync_course_mastery` | L36-87 | 52 | 4 | 2 | 3 | ✓ |
| `predict_course_mastery` | L90-127 | 38 | 4 | 1 | 4 | ✓ |
| `persist_course_mastery` | L130-145 | 16 | 2 | 1 | 3 | ✓ |
| `load_course_point_ids` | L25-33 | 9 | 1 | 0 | 1 | ✓ |

**全部问题 (1)**

- 📏 `sync_course_mastery()` L36: 52 代码量
...
### 195. backend\ai_services\services\mefkt_question_online.py
...
### 196. backend\ai_services\services\mefkt_loader.py
...
### 197. backend\ai_services\services\mefkt_inference.py
...
### 198. backend\ai_services\services\llm_response_mixin.py
...
### 199. backend\ai_services\services\llm_feedback_kt_support.py
...
### 200. backend\ai_services\services\kt_model_runtime.py

**糟糕指数: 0.07**

> 行数: 135 总计, 117 代码, 0 注释 | 函数: 3 | 类: 1

**问题**: ⚠️ 其他问题: 2, 📝 注释问题: 1, 🏷️ 命名问题: 3

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `_predict_with_mefkt` | L79-134 | 56 | 4 | 2 | 4 | ✓ |
| `_load_course_knowledge_point_ids` | L20-42 | 23 | 3 | 1 | 2 | ✓ |
| `_run_model_prediction` | L44-77 | 34 | 3 | 1 | 5 | ✓ |

**全部问题 (4)**

- 📏 `_predict_with_mefkt()` L79: 56 代码量
...
- 🏷️ `_predict_with_mefkt()` L79: "_predict_with_mefkt" - snake_case
...
### 201. frontend\src\views\student\useProfileView.js
...
### 202. frontend\src\stores\user.ts
...
### 203. frontend\src\views\student\useFeedbackReport.js
...
### 209. frontend\scripts\browser-audit.mjs
...
### 213. backend\users\test_profile.py
...
### 214. backend\users\test_models.py
...
### 215. backend\users\test_class_api.py
...
### 216. backend\users\test_auth_api.py
...
### 218. backend\users\teacher_views.py
...
### 219. backend\users\teacher_profile_support.py
...
### 220. backend\users\student_views.py
...
### 221. backend\users\serializers.py
...
### 222. backend\users\auth_views.py

**糟糕指数: 0.00**

> 行数: 108 总计, 85 代码, 0 注释 | 函数: 8 | 类: 1
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `register` | L35-40 | 6 | 2 | 1 | 1 | ✓ |
| `login` | L46-51 | 6 | 2 | 1 | 1 | ✓ |
| `update_userinfo` | L64-70 | 7 | 2 | 1 | 1 | ✓ |
| `token_refresh` | L76-81 | 6 | 2 | 1 | 1 | ✓ |
| `change_password` | L86-91 | 6 | 2 | 1 | 1 | ✓ |
| `userinfo` | L56-59 | 4 | 1 | 0 | 1 | ✓ |
| `logout` | L96-99 | 4 | 1 | 0 | 1 | ✓ |
| `health` | L105-107 | 3 | 1 | 0 | 1 | ✓ |
...
### 224. backend\users\admin_views.py
...
### 225. backend\users\admin_user_management_views.py

**糟糕指数: 0.00**

> 行数: 175 总计, 138 代码, 0 注释 | 函数: 12 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `admin_user_update` | L66-80 | 15 | 5 | 1 | 2 | ✓ |
| `admin_user_delete` | L85-94 | 10 | 3 | 1 | 2 | ✓ |
| `admin_user_disable` | L111-119 | 9 | 3 | 1 | 2 | ✓ |
| `admin_user_import` | L146-159 | 14 | 3 | 1 | 1 | ✓ |
| `admin_user_detail` | L46-51 | 6 | 2 | 1 | 2 | ✓ |
| `admin_user_create` | L56-61 | 6 | 2 | 1 | 1 | ✓ |
| `admin_user_reset_password` | L99-106 | 8 | 2 | 1 | 2 | ✓ |
| `admin_user_enable` | L124-129 | 6 | 2 | 1 | 2 | ✓ |
| `admin_user_batch_delete` | L134-141 | 8 | 2 | 1 | 1 | ✓ |
| `admin_user_list` | L38-41 | 4 | 1 | 0 | 1 | ✓ |
| `admin_user_export` | L164-166 | 3 | 1 | 0 | 1 | ✓ |
| `admin_user_template` | L171-174 | 4 | 1 | 0 | 1 | ✓ |

**全部问题 (1)**

- 📋 `admin_user_reset_password()` L99: 重复模式: admin_user_reset_password, admin_user_batch_delete
...
### 226. backend\users\admin_helpers.py
...
### 228. backend\wisdom_edu_api\__init__.py
...
### 229. backend\wisdom_edu_api\wsgi.py
...
### 230. backend\wisdom_edu_api\urls.py
...
### 231. backend\wisdom_edu_api\settings.py
...
### 232. backend\wisdom_edu_api\asgi.py
...
### 234. backend\tools\rebuild_demo.py
...
### 236. backend\tools\question_import_types.py

**糟糕指数: 0.00**

> 行数: 65 总计, 46 代码, 2 注释 | 函数: 1 | 类: 4
...
### 237. backend\tools\question_import_support.py
...
### 238. backend\tools\question_import_records.py

**糟糕指数: 0.00**

> 行数: 30 总计, 23 代码, 2 注释 | 函数: 1 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `create_question_from_payload` | L15-29 | 15 | 1 | 0 | 2 | ✓ |
...
### 239. backend\tools\mefkt_training.py
...
### 240. backend\tools\mefkt_paths.py
...
### 241. backend\tools\kt_synthetic_support.py
...
### 242. backend\tools\kt_synthetic_math.py
...
### 243. backend\tools\diagnostics.py
...
### 244. backend\tools\db_demo_preset_assessment.py
...
### 245. backend\tools\db_demo_preset.py
...
### 247. backend\tools\browser_audit.py
...
### 248. backend\tools\api_regression_student_exam_ai.py
...
### 249. backend\tools\api_regression_student_basics.py
...
### 250. backend\tools\api_regression_student.py
...
### 251. backend\tools\api_regression_cleanup.py
...
### 252. backend\tools\api_regression_admin.py
...
### 253. backend\platform_ai\__init__.py
...
### 256. backend\logs\serializers.py
...
### 258. backend\logs\logging_setup.py
...
### 261. backend\learning\__init__.py
...
### 262. backend\learning\view_helpers.py
...
### 266. backend\learning\student_rag_views.py

**糟糕指数: 0.00**

> 行数: 22 总计, 16 代码, 0 注释 | 函数: 1 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `get_ai_resources` | L16-21 | 6 | 2 | 1 | 2 | ✓ |
...
### 267. backend\learning\student_rag_support.py

**糟糕指数: 0.00**

> 行数: 138 总计, 112 代码, 0 注释 | 函数: 9 | 类: 0

**问题**: ⚠️ 其他问题: 1, ❌ 错误处理问题: 4, 📝 注释问题: 1

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `build_fallback_resource_payload` | L123-137 | 15 | 4 | 0 | 3 | ✓ |
| `build_ai_resource_payload` | L25-45 | 21 | 3 | 1 | 2 | ✓ |
| `defense_demo_resource_payload` | L53-66 | 14 | 3 | 1 | 3 | ✓ |
| `completed_resource_id_set` | L69-73 | 5 | 3 | 1 | 1 | ✓ |
| `mastery_before_value` | L76-80 | 5 | 3 | 1 | 1 | ✓ |
| `recommend_node_resources` | L83-109 | 27 | 3 | 1 | 4 | ✓ |
| `get_student_path_node` | L16-22 | 7 | 1 | 0 | 2 | ✓ |
| `empty_resource_payload` | L48-50 | 3 | 1 | 0 | 0 | ✓ |
| `fallback_node_resources` | L112-120 | 9 | 1 | 0 | 2 | ✓ |
...
### 268. backend\learning\stage_test_submit_views.py
...
### 269. backend\learning\stage_test_submission.py

**糟糕指数: 0.00**

> 行数: 53 总计, 46 代码, 0 注释 | 函数: 1 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `submit_stage_test_answers` | L17-52 | 36 | 3 | 1 | 3 | ✓ |
...
### 270. backend\learning\stage_test_results.py
...
### 271. backend\learning\stage_test_models.py
...
### 272. backend\learning\stage_test_get_views.py
...
### 273. backend\learning\stage_test_demo_submission.py

**糟糕指数: 0.00**

> 行数: 108 总计, 93 代码, 0 注释 | 函数: 5 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `apply_demo_mastery` | L65-80 | 16 | 3 | 1 | 3 | ✓ |
| `submit_demo_stage_test` | L15-48 | 34 | 2 | 1 | 7 | ✓ |
| `update_demo_node_status` | L51-62 | 12 | 2 | 1 | 4 | ✓ |
| `apply_single_demo_mastery` | L83-101 | 19 | 2 | 1 | 4 | ✓ |
| `demo_feedback_report` | L104-107 | 4 | 2 | 0 | 1 | ✓ |

**全部问题 (1)**

- 📏 `submit_demo_stage_test()` L15: 7 参数数量
...
### 275. backend\learning\models.py
...
### 278. backend\knowledge\__init__.py
...
### 279. backend\knowledge\views.py
...
### 283. backend\knowledge\teacher_resource_views.py

**糟糕指数: 0.00**

> 行数: 154 总计, 131 代码, 0 注释 | 函数: 6 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `resource_create` | L53-73 | 21 | 4 | 1 | 1 | ✓ |
| `resource_update` | L78-96 | 19 | 4 | 1 | 2 | ✓ |
| `resource_upload` | L115-136 | 22 | 4 | 1 | 1 | ✓ |
| `resource_link_knowledge` | L141-153 | 13 | 3 | 1 | 2 | ✓ |
| `resource_list` | L33-48 | 16 | 2 | 1 | 1 | ✓ |
| `resource_delete` | L101-110 | 10 | 2 | 1 | 2 | ✓ |
...
### 284. backend\knowledge\models.py
...
### 286. backend\knowledge\admin.py
...
### 291. backend\exams\teacher_views.py
...
### 292. backend\exams\teacher_result_support.py
...
### 293. backend\exams\student_views.py
...
### 294. backend\exams\student_exam_views.py

**糟糕指数: 0.00**

> 行数: 39 总计, 29 代码, 0 注释 | 函数: 2 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `exam_detail` | L28-38 | 11 | 3 | 1 | 2 | ✓ |
| `exam_list` | L21-23 | 3 | 1 | 0 | 1 | ✓ |
...
### 295. backend\exams\student_class_views.py
...
### 299. backend\courses\__init__.py
...
### 302. backend\courses\teacher_views.py
...
### 303. backend\courses\teacher_course_views.py

**糟糕指数: 0.00**

> 行数: 126 总计, 101 代码, 0 注释 | 函数: 10 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `course_update` | L53-64 | 12 | 4 | 1 | 2 | ✓ |
| `teacher_course_error_response` | L34-38 | 5 | 2 | 1 | 2 | ✓ |
| `course_create` | L43-48 | 6 | 2 | 1 | 1 | ✓ |
| `course_delete` | L76-81 | 6 | 2 | 1 | 2 | ✓ |
| `teacher_course_cover_upload` | L86-91 | 6 | 2 | 1 | 2 | ✓ |
| `teacher_course_statistics` | L96-101 | 6 | 2 | 1 | 2 | ✓ |
| `get_course_settings` | L106-111 | 6 | 2 | 1 | 2 | ✓ |
| `update_course_settings` | L116-125 | 10 | 2 | 1 | 2 | ✓ |
| `course_search` | L29-31 | 3 | 1 | 0 | 1 | ✓ |
| `my_created_courses` | L69-71 | 3 | 1 | 0 | 1 | ✓ |
...
### 304. backend\courses\signals.py
...
### 305. backend\courses\serializers.py
...
### 306. backend\courses\course_cleanup.py
...
### 308. backend\courses\admin_course_class_stats_views.py
...
### 310. backend\common\__init__.py
...
### 313. backend\common\test_responses.py
...
### 315. backend\common\permissions.py
...
### 316. backend\common\pagination.py
...
### 319. backend\common\defense_demo_stage_result.py

**糟糕指数: 0.00**

> 行数: 159 总计, 148 代码, 0 注释 | 函数: 4 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `build_question_detail` | L40-90 | 51 | 2 | 0 | 3 | ✓ |
| `build_demo_stage_test_result` | L111-158 | 48 | 2 | 0 | 4 | ✓ |
| `build_question_result_map` | L28-37 | 10 | 1 | 0 | 1 | ✓ |
| `build_question_details` | L93-108 | 16 | 1 | 0 | 3 | ✓ |

**全部问题 (4)**

- 📏 `build_question_detail()` L40: 51 代码量
- ❌ L88: 未处理的易出错调用
- ❌ L89: 未处理的易出错调用
- ❌ L154: 未处理的易出错调用
...
### 320. backend\common\defense_demo_stage.py

**糟糕指数: 0.00**

> 行数: 369 总计, 336 代码, 0 注释 | 函数: 14 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `build_stage_score_map` | L87-101 | 15 | 4 | 0 | 2 | ✓ |
| `resolve_pass_score` | L122-132 | 11 | 3 | 1 | 2 | ✓ |
| `build_mastery_changes` | L169-199 | 31 | 3 | 2 | 4 | ✓ |
| `resolve_mastery_before` | L202-225 | 24 | 3 | 1 | 4 | ✓ |
| `upsert_stage_submission` | L135-166 | 32 | 2 | 1 | 6 | ✓ |
| `ensure_warmup_stage_submission_and_feedback` | L324-368 | 45 | 2 | 1 | 4 | ✓ |
| `build_stage_feedback_payload` | L22-49 | 28 | 1 | 0 | 1 | ✓ |
| `load_stage_exam_questions` | L52-63 | 12 | 1 | 0 | 1 | ✓ |
| `collect_exam_questions` | L66-72 | 7 | 1 | 0 | 1 | ✓ |
| `build_submission_answers` | L75-84 | 10 | 1 | 0 | 1 | ✓ |
| `grade_stage_exam` | L104-119 | 16 | 1 | 0 | 4 | ✓ |
| `build_mastery_change_item` | L228-246 | 19 | 1 | 0 | 3 | ✓ |
| `upsert_stage_feedback_report` | L249-291 | 43 | 1 | 0 | 8 | ✓ |
| `build_feedback_overview` | L294-321 | 28 | 1 | 0 | 5 | ✓ |

**全部问题 (8)**

- 📏 `upsert_stage_submission()` L135: 6 参数数量
- 📏 `upsert_stage_feedback_report()` L249: 8 参数数量
- ❌ L286: 未处理的易出错调用
- ❌ L287: 未处理的易出错调用
- ❌ L288: 未处理的易出错调用
- ❌ L289: 未处理的易出错调用
...
### 321. backend\common\defense_demo_environment.py

**糟糕指数: 0.00**

> 行数: 125 总计, 113 代码, 0 注释 | 函数: 1 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `ensure_defense_demo_environment` | L34-124 | 91 | 4 | 1 | 1 | ✓ |

**全部问题 (1)**

- 📏 `ensure_defense_demo_environment()` L34: 91 代码量
...
### 322. backend\common\defense_demo_config.py
...
### 323. backend\common\defense_demo_accounts.py
...
### 324. backend\common\defense_demo.py
...
### 327. backend\assessments\__init__.py
...
### 328. backend\assessments\views.py
...
### 329. backend\assessments\urls.py
...
### 330. backend\assessments\tests.py
...
### 331. backend\assessments\question_models.py
...
### 332. backend\assessments\models.py
...
### 333. backend\assessments\history_models.py
...
### 334. backend\assessments\habit_survey_defaults.py
...
### 335. backend\assessments\assessment_models.py
...
### 336. backend\assessments\apps.py
...
### 337. backend\assessments\admin.py
...
### 338. backend\assessments\ability_survey_defaults.py
...
### 339. backend\application\__init__.py
...
### 340. backend\ai_services\__init__.py
...
### 341. backend\ai_services\views.py
...
### 342. backend\ai_services\urls.py
...
### 343. backend\ai_services\tests.py
...
### 344. backend\ai_services\student_rag_support.py
...
### 345. backend\ai_services\student_ai_views.py
...
### 346. backend\ai_services\serializers.py
...
### 347. backend\ai_services\routing.py
...
### 348. backend\ai_services\models.py
...
### 349. backend\ai_services\kt_views.py
...
### 350. backend\ai_services\apps.py
...
### 351. backend\ai_services\admin.py
...
### 352. frontend\src\utils\markdown.ts
...
### 353. frontend\src\utils\logger.ts
...
### 354. frontend\src\utils\courseCover.ts
...
### 355. frontend\src\router\index.ts
...
### 356. frontend\src\router\guards.ts
...
### 357. frontend\src\stores\index.ts
...
### 358. frontend\src\stores\assessment.ts
...
### 359. frontend\src\composables\useCourse.ts
...
### 360. frontend\src\composables\useAIProgress.ts
...
### 362. frontend\src\api\course.ts
...
### 364. frontend\src\api\authTokens.ts
...
### 366. frontend\scripts\browser-audit\student-prep.mjs
...
### 367. frontend\scripts\browser-audit\session.mjs
...
### 368. frontend\scripts\browser-audit\files.mjs
...
### 369. frontend\scripts\browser-audit\demo-scenario.mjs
...
### 370. frontend\scripts\browser-audit\defense-scenario.mjs
...
### 371. frontend\scripts\browser-audit\context.mjs
...
### 372. frontend\scripts\browser-audit\constants.mjs
...
### 373. frontend\scripts\browser-audit\audit-scenario.mjs
...
### 374. frontend\scripts\browser-audit\api.mjs
...
### 375. frontend\scripts\browser-audit\answers.mjs
...
### 376. backend\users\migrations\__init__.py
...
### 377. backend\users\migrations\0005_remove_habitpreference_reminder_settings.py
...
### 378. backend\users\migrations\0004_alter_habitpreference_review_frequency.py
...
### 379. backend\users\migrations\0003_alter_user_email_alter_user_phone.py
...
### 380. backend\users\migrations\0002_habitpreference_accept_challenge_and_more.py
...
### 381. backend\users\migrations\0001_initial.py
...
### 382. backend\platform_ai\search\__init__.py
...
### 383. backend\platform_ai\search\providers.py
...
### 384. backend\platform_ai\rag\__init__.py
...
### 385. backend\platform_ai\rag\student_dependencies.py
...
### 386. backend\platform_ai\rag\student_answer_mixin.py
...
### 387. backend\platform_ai\rag\student.py
...
### 388. backend\platform_ai\rag\runtime_proxies.py
...
### 389. backend\platform_ai\rag\runtime_course.py
...
### 390. backend\platform_ai\rag\corpus_types.py
...
### 391. backend\platform_ai\rag\corpus_storage.py
...
### 392. backend\platform_ai\rag\corpus.py
...
### 393. backend\models\MEFKT\__init__.py
...
### 394. backend\models\MEFKT\model.py
...
### 395. backend\models\MEFKT\fusion.py
...
### 396. backend\models\MEFKT\constants.py
...
### 397. backend\platform_ai\mcp\__init__.py
...
### 398. backend\platform_ai\llm\__init__.py
...
### 399. backend\platform_ai\llm\facade.py
...
### 400. backend\platform_ai\llm\agent_support.py
...
### 401. backend\platform_ai\llm\agent_message.py

**糟糕指数: 0.00**

> 行数: 34 总计, 25 代码, 0 注释 | 函数: 3 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `extract_agent_message_text` | L5-9 | 5 | 4 | 1 | 1 | ✓ |
| `extract_content_part_text` | L20-26 | 7 | 4 | 1 | 1 | ✓ |
| `extract_message_content` | L12-17 | 6 | 2 | 1 | 1 | ✓ |
...
### 402. backend\platform_ai\kt\__init__.py
...
### 403. backend\platform_ai\kt\torch_device.py
...
### 404. backend\platform_ai\kt\facade.py
...
### 405. backend\platform_ai\kt\datasets.py
...
### 406. backend\logs\migrations\__init__.py
...
### 407. backend\logs\migrations\0002_alter_operationlog_module.py
...
### 408. backend\logs\migrations\0001_initial.py
...
### 409. backend\learning\migrations\__init__.py
...
### 410. backend\learning\migrations\0005_nodeprogress_extra_data.py
...
### 411. backend\learning\migrations\0004_pathnode_estimated_minutes_pathnode_node_type.py
...
### 412. backend\learning\migrations\0003_add_skipped_status.py
...
### 413. backend\learning\migrations\0002_initial.py
...
### 414. backend\learning\migrations\0001_initial.py
...
### 415. backend\knowledge\migrations\__init__.py
...
### 416. backend\knowledge\migrations\0006_knowledgepoint_introduction_fields.py
...
### 417. backend\knowledge\migrations\0005_alter_knowledgerelation_relation_type.py
...
### 418. backend\knowledge\migrations\0004_resource_chapter_number_resource_duration_and_more.py
...
### 419. backend\knowledge\migrations\0003_knowledgepoint_category_and_more.py
...
### 421. backend\knowledge\migrations\0001_initial.py
...
### 422. backend\exams\migrations\__init__.py
...
### 423. backend\exams\migrations\0003_alter_feedbackreport_unique_together_and_more.py
...
### 424. backend\exams\migrations\0002_initial.py
...
### 425. backend\exams\migrations\0001_initial.py
...
### 426. backend\courses\migrations\__init__.py
...
### 427. backend\courses\migrations\0005_announcement.py
...
### 428. backend\courses\migrations\0004_course_config.py
...
### 429. backend\courses\migrations\0003_alter_class_options_class_description_and_more.py
...
### 430. backend\courses\migrations\0002_initial.py
...
### 431. backend\courses\migrations\0001_initial.py
...
### 432. backend\common\migrations\__init__.py
...
### 433. backend\assessments\migrations\__init__.py
...
### 434. backend\assessments\migrations\0006_assessmentstatus_generating_and_more.py
...
### 435. backend\assessments\migrations\0005_question_chapter_question_suggested_score.py
...
### 436. backend\assessments\migrations\0004_alter_surveyquestion_options_and_more.py
...
### 437. backend\assessments\migrations\0003_initial.py
...
### 438. backend\assessments\migrations\0002_initial.py
...
### 439. backend\assessments\migrations\0001_initial.py
...
### 440. backend\application\teacher\__init__.py
...
### 441. backend\application\teacher\workspace.py
...
### 442. backend\ai_services\services\__init__.py
...
### 443. backend\ai_services\services\student_graph_rag_service.py

**糟糕指数: 0.00**

> 行数: 24 总计, 15 代码, 0 注释 | 函数: 2 | 类: 1
...
### 444. backend\ai_services\services\mefkt_runtime_types.py

**糟糕指数: 0.00**

> 行数: 105 总计, 75 代码, 2 注释 | 函数: 1 | 类: 8
...
### 445. backend\ai_services\services\mefkt_runtime_support.py
...
### 446. backend\ai_services\services\mefkt_runtime_sources.py

**糟糕指数: 0.00**

> 行数: 118 总计, 97 代码, 2 注释 | 函数: 6 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `collect_point_resource_map` | L39-45 | 7 | 3 | 2 | 1 | ✓ |
| `collect_question_answer_stats` | L92-106 | 15 | 3 | 1 | 1 | ✓ |
| `collect_knowledge_relation_maps` | L48-71 | 24 | 2 | 1 | 1 | ✓ |
| `register_relation_row` | L74-89 | 16 | 2 | 1 | 6 | ✓ |
| `load_runtime_source_data` | L10-36 | 27 | 1 | 0 | 1 | ✓ |
| `build_feature_sources` | L109-117 | 9 | 1 | 0 | 1 | ✓ |

**全部问题 (1)**

- 📏 `register_relation_row()` L74: 6 参数数量
...
### 447. backend\ai_services\services\mefkt_runtime_rows.py

**糟糕指数: 0.00**

> 行数: 215 总计, 190 代码, 2 注释 | 函数: 8 | 类: 1

**问题**: ⚠️ 其他问题: 4, ❌ 错误处理问题: 1, 📝 注释问题: 1, 🏷️ 命名问题: 1

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `build_single_feature_row` | L66-98 | 33 | 2 | 0 | 9 | ✓ |
| `build_feature_value_map` | L101-130 | 30 | 2 | 0 | 8 | ✓ |
| `build_runtime_feature_rows` | L133-162 | 30 | 2 | 1 | 7 | ✓ |
| `build_neighbor_difficulty_tensor` | L24-37 | 14 | 1 | 0 | 2 | ✓ |
| `build_relation_stats_matrix` | L40-63 | 24 | 1 | 0 | 2 | ✓ |
| `__init__` | L168-172 | 5 | 1 | 0 | 2 | ✗ |
| `add_row` | L174-201 | 28 | 1 | 0 | 10 | ✓ |
| `to_tuple` | L203-214 | 12 | 1 | 0 | 2 | ✓ |

**全部问题 (6)**

- 📏 `build_single_feature_row()` L66: 9 参数数量
- 📏 `build_feature_value_map()` L101: 8 参数数量
- 📏 `build_runtime_feature_rows()` L133: 7 参数数量
- 📏 `add_row()` L174: 10 参数数量
- ❌ L125: 未处理的易出错调用
- 🏷️ `__init__()` L168: "__init__" - snake_case
...
### 448. backend\ai_services\services\mefkt_runtime_features.py

**糟糕指数: 0.00**

> 行数: 254 总计, 226 代码, 2 注释 | 函数: 11 | 类: 1

**问题**: ⚠️ 其他问题: 3, 📋 重复问题: 1, ❌ 错误处理问题: 1, 📝 注释问题: 1

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `collect_question_feature_entry` | L31-65 | 35 | 3 | 0 | 4 | ✓ |
| `build_question_raw_values` | L116-136 | 21 | 3 | 0 | 7 | ✓ |
| `build_chapter_norm_map` | L17-28 | 12 | 2 | 0 | 2 | ✓ |
| `prepare_question_features` | L168-197 | 30 | 2 | 1 | 4 | ✓ |
| `add_question` | L217-242 | 26 | 2 | 1 | 4 | ✓ |
| `collect_resource_ids` | L68-77 | 10 | 1 | 0 | 2 | ✓ |
| `collect_relation_counts` | L80-88 | 9 | 1 | 0 | 2 | ✓ |
| `build_question_meta` | L91-113 | 23 | 1 | 0 | 7 | ✓ |
| `normalize_question_feature_scales` | L139-165 | 27 | 1 | 0 | 10 | ✓ |
| `__init__` | L203-215 | 13 | 1 | 0 | 3 | ✗ |
| `to_preparation` | L244-253 | 10 | 1 | 0 | 2 | ✓ |

**全部问题 (5)**

- 📏 `build_question_meta()` L91: 7 参数数量
- 📏 `build_question_raw_values()` L116: 7 参数数量
- 📏 `normalize_question_feature_scales()` L139: 10 参数数量
- 📋 `build_chapter_norm_map()` L17: 重复模式: build_chapter_norm_map, collect_relation_counts
- ❌ L76: 未处理的易出错调用
...
### 449. backend\ai_services\services\mefkt_runtime.py
...
### 450. backend\ai_services\services\llm_resource_mixin.py
...
### 451. backend\ai_services\services\llm_provider_config.py
...
### 452. backend\ai_services\services\llm_profile_path_mixin.py
...
### 453. backend\ai_services\services\llm_feedback_kt_mixin.py
...
### 454. backend\ai_services\migrations\__init__.py
...
### 455. backend\ai_services\migrations\0003_add_chat_kt_call_types.py
...
### 456. backend\ai_services\migrations\0002_initial.py
...
### 457. backend\ai_services\migrations\0001_initial.py
...
### 458. frontend\src\views\teacher\useTeacherKnowledgeManage.js
...
### 459. frontend\src\views\teacher\useTeacherExamManage.js
...
### 460. frontend\src\views\teacher\resourceManageModels.js
...
### 461. frontend\src\views\teacher\questionListModels.js
...
### 462. frontend\src\views\teacher\knowledgeManageModels.js
...
### 463. frontend\src\views\student\useTaskLearning.js
...
### 464. frontend\src\views\student\useStudentKnowledgeMap.js
...
### 465. frontend\src\views\student\learningPathModels.js
...
### 466. frontend\src\views\student\knowledgeMapModels.js
...
### 467. frontend\src\views\student\examTakingModels.js
...
### 468. frontend\src\router\routes\teacher.ts
...
### 469. frontend\src\router\routes\student.ts
...
### 470. frontend\src\router\routes\auth.ts
...
### 471. frontend\src\router\routes\admin.ts
...
### 472. frontend\src\components\knowledge\useKnowledgeGraphD3.js
...
### 473. frontend\src\components\knowledge\knowledgeGraphModels.js
...
### 474. frontend\src\api\teacher\settings.ts
...
### 475. frontend\src\api\teacher\question.ts
...
### 476. frontend\src\api\teacher\knowledge.ts
...
### 477. frontend\src\api\teacher\index.ts
...
### 478. frontend\src\api\teacher\exam.ts
...
### 479. frontend\src\api\teacher\course.ts
...
### 480. frontend\src\api\teacher\class.ts
...
### 481. frontend\src\api\student\profile.ts
...
### 482. frontend\src\api\student\learning.ts
...
### 483. frontend\src\api\student\knowledge.ts
...
### 484. frontend\src\api\student\index.ts
...
### 485. frontend\src\api\student\exam.ts
...
### 486. frontend\src\api\student\class.ts
...
### 487. frontend\src\api\student\assessment.ts
...
### 488. frontend\src\api\student\ai.ts
...
### 489. frontend\src\api\admin\user.ts
...
### 490. frontend\src\api\admin\statistics.ts
...
### 491. frontend\src\api\admin\profile.ts
...
### 492. frontend\src\api\admin\log.ts
...
### 493. frontend\src\api\admin\index.ts
...
### 494. frontend\src\api\admin\course.ts
...
### 495. frontend\src\api\admin\class.ts
...
### 496. frontend\src\api\admin\activation.ts
...
| 函数 | 文件 | 复杂度 | 嵌套 | 行数 |
|:-----|:-----|------:|------:|------:|
| `build_excel_question_payload` | backend\tools\question_import_excel.py | 20 | 1 | 44 |
...
| `_build_exam_answers` | backend\tools\api_regression_helpers.py | 16 | 3 | 37 |
| `build_tools_query_context` | backend\platform_ai\rag\runtime_graph_query_support.py | 16 | 2 | 56 |
| `_load_llm_settings` | backend\wisdom_edu_api\settings_ai.py | 15 | 1 | 79 |
| `_load_csv_sequences` | backend\tools\mefkt_public_data.py | 15 | 2 | 41 |
| `parse_hierarchical_knowledge_excel` | backend\tools\knowledge_import_support.py | 15 | 3 | 75 |
