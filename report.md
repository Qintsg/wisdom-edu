...
|:-----|------:|------:|------:|------:|:------:|
| 循环复杂度 | 6.27% | 0.0% | 65.5% | 0.0% | ✓✓ |
| 认知复杂度 | 7.43% | 0.0% | 57.8% | 0.0% | ✓✓ |
| 嵌套深度 | 0.54% | 0.0% | 20.0% | 0.0% | ✓✓ |
| 函数长度 | 6.48% | 0.0% | 75.9% | 0.0% | ✓✓ |
| 文件长度 | 0.58% | 0.0% | 48.2% | 0.0% | ✓✓ |
| 参数数量 | 6.67% | 0.0% | 98.5% | 0.0% | ✓✓ |
| 代码重复 | 3.09% | 0.0% | 94.2% | 0.0% | ✓✓ |
| 结构分析 | 1.09% | 0.0% | 16.0% | 0.0% | ✓✓ |
| 错误处理 | 18.03% | 0.0% | 98.8% | 0.0% | ✓✓ |
| 注释比例 | 77.13% | 0.0% | 100.0% | 100.0% | ! |
| 命名规范 | 17.21% | 0.0% | 100.0% | 0.0% | ✓✓ |

## 最屎代码排行榜 {#problem-files}

### 1. backend\ai_services\services\mefkt_inference.py

**糟糕指数: 26.89**

> 行数: 500 总计, 449 代码, 2 注释 | 函数: 13 | 类: 1

**问题**: 🔄 复杂度问题: 5, ⚠️ 其他问题: 5, 🏗️ 结构问题: 2, ❌ 错误处理问题: 12, 📝 注释问题: 1, 🏷️ 命名问题: 8

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `load_model` | L68-158 | 91 | 23 | 2 | 3 | ✓ |
| `_predict_question_online` | L300-452 | 153 | 17 | 3 | 4 | ✓ |
| `_predict_legacy` | L243-298 | 56 | 8 | 3 | 3 | ✓ |
| `_resolve_backend_path` | L31-41 | 11 | 4 | 1 | 1 | ✓ |
| `_build_history_tensors_legacy` | L160-188 | 29 | 4 | 2 | 2 | ✓ |
| `_resolve_runtime_history_index` | L198-213 | 16 | 4 | 2 | 3 | ✓ |
| `predict` | L454-472 | 19 | 4 | 2 | 4 | ✓ |
| `_build_history_tensors_runtime` | L215-241 | 27 | 3 | 2 | 3 | ✓ |
| `is_loaded` | L64-66 | 3 | 2 | 0 | 1 | ✓ |
| `_build_course_runtime_bundle` | L190-196 | 7 | 2 | 1 | 2 | ✓ |
| `__init__` | L47-61 | 15 | 1 | 0 | 1 | ✗ |
| `get_info` | L474-489 | 16 | 1 | 0 | 1 | ✓ |
| `auto_load_model` | L495-499 | 5 | 1 | 0 | 0 | ✓ |

**全部问题 (30)**

- 🔄 `load_model()` L68: 复杂度: 23
- 🔄 `_predict_question_online()` L300: 复杂度: 17
- 🔄 `load_model()` L68: 认知复杂度: 27
- 🔄 `_predict_legacy()` L243: 认知复杂度: 14
- 🔄 `_predict_question_online()` L300: 认知复杂度: 23
- 📏 `load_model()` L68: 91 代码量
- 📏 `_predict_legacy()` L243: 56 代码量
- 📏 `_predict_question_online()` L300: 153 代码量
- 🏗️ `_predict_legacy()` L243: 中等嵌套: 3
- 🏗️ `_predict_question_online()` L300: 中等嵌套: 3
- ❌ L111: 未处理的易出错调用
- ❌ L118: 未处理的易出错调用
- ❌ L386: 未处理的易出错调用
- ❌ L393: 未处理的易出错调用
...
- ❌ L487: 未处理的易出错调用
- ❌ L488: 未处理的易出错调用
- 🏷️ `_resolve_backend_path()` L31: "_resolve_backend_path" - snake_case
- 🏷️ `__init__()` L47: "__init__" - snake_case
- 🏷️ `_build_history_tensors_legacy()` L160: "_build_history_tensors_legacy" - snake_case
- 🏷️ `_build_course_runtime_bundle()` L190: "_build_course_runtime_bundle" - snake_case
- 🏷️ `_resolve_runtime_history_index()` L198: "_resolve_runtime_history_index" - snake_case
- 🏷️ `_build_history_tensors_runtime()` L215: "_build_history_tensors_runtime" - snake_case
- 🏷️ `_predict_legacy()` L243: "_predict_legacy" - snake_case
- 🏷️ `_predict_question_online()` L300: "_predict_question_online" - snake_case

**详情**:
- 循环复杂度: 平均: 5.7, 最大: 23
- 认知复杂度: 平均: 8.5, 最大: 27
- 嵌套深度: 平均: 1.4, 最大: 3
- 函数长度: 平均: 34.5 行, 最大: 153 行
- 文件长度: 449 代码量 (500 总计)
- 参数数量: 平均: 2.2, 最大: 4
- 代码重复: 0.0% 重复 (0/13)
- 结构分析: 2 个结构问题
- 错误处理: 12/42 个错误被忽略 (28.6%)
- 注释比例: 0.4% (2/449)
- 命名规范: 发现 8 个违规

### 2. backend\platform_ai\rag\student_answer_mixin.py

**糟糕指数: 26.86**

> 行数: 216 总计, 191 代码, 0 注释 | 函数: 2 | 类: 1

**问题**: 🔄 复杂度问题: 2, ⚠️ 其他问题: 3, 🏗️ 结构问题: 1, ❌ 错误处理问题: 6, 📝 注释问题: 1

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `answer_course_question` | L105-215 | 111 | 16 | 3 | 4 | ✓ |
| `answer_graph_question` | L28-103 | 76 | 10 | 1 | 4 | ✓ |

**全部问题 (11)**

- 🔄 `answer_course_question()` L105: 复杂度: 16
- 🔄 `answer_course_question()` L105: 认知复杂度: 22
- 📏 `answer_graph_question()` L28: 76 代码量
- 📏 `answer_course_question()` L105: 111 代码量
- 🏗️ `answer_course_question()` L105: 中等嵌套: 3
- ❌ L47: 未处理的易出错调用
- ❌ L98: 未处理的易出错调用
- ❌ L102: 未处理的易出错调用
- ❌ L142: 未处理的易出错调用
...
- 认知复杂度: 平均: 17.0, 最大: 22
- 嵌套深度: 平均: 2.0, 最大: 3
- 函数长度: 平均: 93.5 行, 最大: 111 行
- 文件长度: 191 代码量 (216 总计)
- 参数数量: 平均: 4.0, 最大: 4
- 代码重复: 未发现函数
- 结构分析: 1 个结构问题
- 错误处理: 6/15 个错误被忽略 (40.0%)
- 注释比例: 0.0% (0/191)
- 命名规范: 无命名违规

### 3. backend\exams\student_initial_assessment_views.py

**糟糕指数: 26.79**

> 行数: 144 总计, 124 代码, 0 注释 | 函数: 2 | 类: 0

**问题**: 🔄 复杂度问题: 3, ⚠️ 其他问题: 1, 🏗️ 结构问题: 1, ❌ 错误处理问题: 1, 📝 注释问题: 1

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `initial_assessment_submit` | L56-143 | 88 | 19 | 4 | 1 | ✓ |
| `initial_assessment_start` | L25-51 | 27 | 4 | 1 | 1 | ✓ |

**全部问题 (6)**

- 🔄 `initial_assessment_submit()` L56: 复杂度: 19
- 🔄 `initial_assessment_submit()` L56: 认知复杂度: 27
- 🔄 `initial_assessment_submit()` L56: 嵌套深度: 4
- 📏 `initial_assessment_submit()` L56: 88 代码量
- 🏗️ `initial_assessment_submit()` L56: 中等嵌套: 4
- ❌ L90: 未处理的易出错调用
...
### 4. backend\ai_services\services\llm_feedback_kt_mixin.py

**糟糕指数: 26.55**

> 行数: 269 总计, 221 代码, 9 注释 | 函数: 2 | 类: 1

**问题**: 🔄 复杂度问题: 4, ⚠️ 其他问题: 3, ❌ 错误处理问题: 10, 📝 注释问题: 1

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `generate_feedback_report` | L15-158 | 144 | 14 | 1 | 6 | ✓ |
| `analyze_knowledge_tracing_result` | L160-268 | 109 | 12 | 1 | 5 | ✓ |

**全部问题 (17)**

- 🔄 `generate_feedback_report()` L15: 复杂度: 14
- 🔄 `analyze_knowledge_tracing_result()` L160: 复杂度: 12
- 🔄 `generate_feedback_report()` L15: 认知复杂度: 16
- 🔄 `analyze_knowledge_tracing_result()` L160: 认知复杂度: 14
- 📏 `generate_feedback_report()` L15: 144 代码量
- 📏 `analyze_knowledge_tracing_result()` L160: 109 代码量
- 📏 `generate_feedback_report()` L15: 6 参数数量
- ❌ L42: 未处理的易出错调用
- ❌ L43: 未处理的易出错调用
- ❌ L44: 未处理的易出错调用
- ❌ L45: 未处理的易出错调用
...
- 认知复杂度: 平均: 15.0, 最大: 16
- 嵌套深度: 平均: 1.0, 最大: 1
- 函数长度: 平均: 126.5 行, 最大: 144 行
- 文件长度: 221 代码量 (269 总计)
- 参数数量: 平均: 5.5, 最大: 6
- 代码重复: 未发现函数
- 结构分析: 0 个结构问题
- 错误处理: 10/17 个错误被忽略 (58.8%)
- 注释比例: 4.1% (9/221)
- 命名规范: 无命名违规

### 5. backend\tools\api_regression_cleanup.py

**糟糕指数: 26.52**

> 行数: 144 总计, 132 代码, 5 注释 | 函数: 1 | 类: 0

**问题**: 🔄 复杂度问题: 2, ⚠️ 其他问题: 2, ❌ 错误处理问题: 9, 📝 注释问题: 1, 🏷️ 命名问题: 1

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `_cleanup_regression_entities` | L15-143 | 129 | 11 | 1 | 7 | ✓ |

**全部问题 (14)**

- 🔄 `_cleanup_regression_entities()` L15: 复杂度: 11
- 🔄 `_cleanup_regression_entities()` L15: 认知复杂度: 13
- 📏 `_cleanup_regression_entities()` L15: 129 代码量
- 📏 `_cleanup_regression_entities()` L15: 7 参数数量
- ❌ L38: 未处理的易出错调用
- ❌ L50: 未处理的易出错调用
- ❌ L61: 未处理的易出错调用
- ❌ L72: 未处理的易出错调用
...
- ❌ L118: 未处理的易出错调用
- ❌ L133: 未处理的易出错调用
- 🏷️ `_cleanup_regression_entities()` L15: "_cleanup_regression_entities" - snake_case

**详情**:
- 循环复杂度: 平均: 11.0, 最大: 11
- 认知复杂度: 平均: 13.0, 最大: 13
- 嵌套深度: 平均: 1.0, 最大: 1
- 函数长度: 平均: 129.0 行, 最大: 129 行
- 文件长度: 132 代码量 (144 总计)
- 参数数量: 平均: 7.0, 最大: 7
- 代码重复: 未发现函数
- 结构分析: 0 个结构问题
- 错误处理: 9/9 个错误被忽略 (100.0%)
- 注释比例: 3.8% (5/132)
- 命名规范: 发现 1 个违规

### 6. backend\tools\survey.py

**糟糕指数: 25.89**

> 行数: 125 总计, 102 代码, 0 注释 | 函数: 2 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `import_survey_questions` | L17-119 | 103 | 17 | 5 | 3 | ✓ |
| `import_ability_scale` | L122-124 | 3 | 1 | 0 | 2 | ✓ |

**全部问题 (6)**

- 🔄 `import_survey_questions()` L17: 复杂度: 17
- 🔄 `import_survey_questions()` L17: 认知复杂度: 27
- 🔄 `import_survey_questions()` L17: 嵌套深度: 5
- 📏 `import_survey_questions()` L17: 103 代码量
- 🏗️ `import_survey_questions()` L17: 嵌套过深: 5
- ❌ L107: 未处理的易出错调用
...
### 7. backend\users\student_views.py

**糟糕指数: 25.72**

> 行数: 337 总计, 286 代码, 6 注释 | 函数: 7 | 类: 1

**问题**: 🔄 复杂度问题: 2, ⚠️ 其他问题: 1, ❌ 错误处理问题: 8, 📝 注释问题: 1

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `get_profile` | L32-159 | 128 | 35 | 2 | 1 | ✓ |
| `profile_export` | L303-336 | 34 | 4 | 0 | 1 | ✓ |
| `update_student_profile` | L182-215 | 34 | 3 | 1 | 1 | ✓ |
| `get_profile_history` | L220-257 | 38 | 3 | 1 | 1 | ✓ |
| `profile_compare` | L262-298 | 27 | 3 | 1 | 1 | ✓ |
| `snapshot_data` | L280-289 | 10 | 3 | 1 | 1 | ✓ |
| `update_habit_preference` | L164-177 | 14 | 2 | 1 | 1 | ✓ |

**全部问题 (11)**

- 🔄 `get_profile()` L32: 复杂度: 35
- 🔄 `get_profile()` L32: 认知复杂度: 39
- 📏 `get_profile()` L32: 128 代码量
- ❌ L104: 未处理的易出错调用
- ❌ L125: 未处理的易出错调用
- ❌ L200: 未处理的易出错调用
- ❌ L208: 未处理的易出错调用
...
- 认知复杂度: 平均: 9.6, 最大: 39
- 嵌套深度: 平均: 1.0, 最大: 2
- 函数长度: 平均: 40.7 行, 最大: 128 行
- 文件长度: 286 代码量 (337 总计)
- 参数数量: 平均: 1.0, 最大: 1
- 代码重复: 0.0% 重复 (0/7)
- 结构分析: 0 个结构问题
- 错误处理: 8/15 个错误被忽略 (53.3%)
- 注释比例: 2.1% (6/286)
- 命名规范: 无命名违规

### 8. backend\tools\db_demo_preset.py

**糟糕指数: 25.51**

> 行数: 271 总计, 237 代码, 0 注释 | 函数: 4 | 类: 0

**问题**: 🔄 复杂度问题: 2, ⚠️ 其他问题: 1, 🏗️ 结构问题: 1, ❌ 错误处理问题: 3, 📝 注释问题: 1, 🏷️ 命名问题: 3

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `_preset_student1_demo_data` | L53-251 | 199 | 19 | 3 | 2 | ✓ |
| `preset_student1_demo_course_state` | L254-270 | 17 | 4 | 1 | 1 | ✓ |
| `_calculate_initial_mastery_baseline` | L23-31 | 9 | 2 | 1 | 2 | ✓ |
| `_reset_course_demo_state` | L34-50 | 17 | 1 | 0 | 2 | ✓ |

**全部问题 (10)**

- 🔄 `_preset_student1_demo_data()` L53: 复杂度: 19
- 🔄 `_preset_student1_demo_data()` L53: 认知复杂度: 25
- 📏 `_preset_student1_demo_data()` L53: 199 代码量
- 🏗️ `_preset_student1_demo_data()` L53: 中等嵌套: 3
- ❌ L100: 未处理的易出错调用
- ❌ L139: 未处理的易出错调用
- ❌ L203: 未处理的易出错调用
- 🏷️ `_calculate_initial_mastery_baseline()` L23: "_calculate_initial_mastery_baseline" - snake_case
- 🏷️ `_reset_course_demo_state()` L34: "_reset_course_demo_state" - snake_case
- 🏷️ `_preset_student1_demo_data()` L53: "_preset_student1_demo_data" - snake_case

**详情**:
- 循环复杂度: 平均: 6.5, 最大: 19
- 认知复杂度: 平均: 9.0, 最大: 25
- 嵌套深度: 平均: 1.3, 最大: 3
- 函数长度: 平均: 60.5 行, 最大: 199 行
- 文件长度: 237 代码量 (271 总计)
- 参数数量: 平均: 1.8, 最大: 2
- 代码重复: 0.0% 重复 (0/4)
- 结构分析: 1 个结构问题
- 错误处理: 3/13 个错误被忽略 (23.1%)
- 注释比例: 0.0% (0/237)
- 命名规范: 发现 3 个违规

### 9. backend\tools\mefkt_training.py

**糟糕指数: 25.25**

> 行数: 315 总计, 286 代码, 2 注释 | 函数: 4 | 类: 0

**问题**: 🔄 复杂度问题: 1, ⚠️ 其他问题: 4, 🏗️ 结构问题: 1, ❌ 错误处理问题: 7, 📝 注释问题: 1, 🏷️ 命名问题: 2

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `train_mefkt_v2` | L218-283 | 66 | 9 | 1 | 17 | ✓ |
| `_train_mefkt_bundle` | L54-215 | 162 | 8 | 3 | 13 | ✓ |
| `mefkt_status` | L286-311 | 26 | 2 | 1 | 0 | ✓ |
| `_write_mefkt_metadata` | L48-51 | 4 | 1 | 0 | 2 | ✓ |

**全部问题 (15)**

- 🔄 `_train_mefkt_bundle()` L54: 认知复杂度: 14
- 📏 `_train_mefkt_bundle()` L54: 162 代码量
- 📏 `train_mefkt_v2()` L218: 66 代码量
- 📏 `_train_mefkt_bundle()` L54: 13 参数数量
- 📏 `train_mefkt_v2()` L218: 17 参数数量
- 🏗️ `_train_mefkt_bundle()` L54: 中等嵌套: 3
- ❌ L302: 未处理的易出错调用
- ❌ L303: 未处理的易出错调用
- ❌ L304: 未处理的易出错调用
- ❌ L305: 未处理的易出错调用
...
- ❌ L307: 未处理的易出错调用
- ❌ L308: 未处理的易出错调用
- 🏷️ `_write_mefkt_metadata()` L48: "_write_mefkt_metadata" - snake_case
- 🏷️ `_train_mefkt_bundle()` L54: "_train_mefkt_bundle" - snake_case

**详情**:
- 循环复杂度: 平均: 5.0, 最大: 9
- 认知复杂度: 平均: 7.5, 最大: 14
- 嵌套深度: 平均: 1.3, 最大: 3
- 函数长度: 平均: 64.5 行, 最大: 162 行
- 文件长度: 286 代码量 (315 总计)
- 参数数量: 平均: 8.0, 最大: 17
- 代码重复: 0.0% 重复 (0/4)
- 结构分析: 1 个结构问题
...
### 10. backend\ai_services\services\llm_response_mixin.py

**糟糕指数: 24.97**

> 行数: 443 总计, 390 代码, 6 注释 | 函数: 17 | 类: 1

**问题**: 🔄 复杂度问题: 4, ⚠️ 其他问题: 6, 🏗️ 结构问题: 2, ❌ 错误处理问题: 2, 📝 注释问题: 1, 🏷️ 命名问题: 10

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `_call_with_fallback` | L318-399 | 82 | 11 | 2 | 6 | ✓ |
| `_post_process_response` | L421-442 | 22 | 9 | 5 | 2 | ✓ |
| `_parse_json_response` | L69-111 | 43 | 7 | 2 | 1 | ✓ |
| `_format_input_data` | L27-54 | 28 | 5 | 3 | 2 | ✓ |
| `_run_agent_json_call` | L185-219 | 35 | 5 | 1 | 6 | ✓ |
| `_merge_missing_fields` | L308-316 | 9 | 5 | 2 | 2 | ✓ |
| `_coerce_message_text` | L114-125 | 12 | 4 | 1 | 1 | ✓ |
| `_attempt_llm_json_response` | L233-255 | 23 | 4 | 1 | 5 | ✓ |
| `_run_llm_json_call` | L257-305 | 49 | 4 | 2 | 7 | ✓ |
| `_apply_temperature_override` | L157-163 | 7 | 3 | 1 | 2 | ✓ |
| `_strip_reasoning_blocks` | L57-66 | 10 | 2 | 1 | 1 | ✓ |
| `_restore_temperature` | L151-154 | 4 | 2 | 1 | 2 | ✓ |
| `_build_retry_prompt` | L166-173 | 8 | 2 | 1 | 2 | ✓ |
| `_repair_json_response` | L127-148 | 22 | 1 | 0 | 4 | ✓ |
| `_finalize_success_response` | L175-183 | 9 | 1 | 0 | 4 | ✓ |
| `_invoke_llm_messages` | L221-231 | 11 | 1 | 0 | 3 | ✓ |
| `call_with_fallback` | L401-416 | 16 | 1 | 0 | 6 | ✓ |

**全部问题 (23)**

- 🔄 `_call_with_fallback()` L318: 复杂度: 11
- 🔄 `_call_with_fallback()` L318: 认知复杂度: 15
- 🔄 `_post_process_response()` L421: 认知复杂度: 19
- 🔄 `_post_process_response()` L421: 嵌套深度: 5
- 📏 `_call_with_fallback()` L318: 82 代码量
- 📏 `_run_agent_json_call()` L185: 6 参数数量
- 📏 `_run_llm_json_call()` L257: 7 参数数量
- 📏 `_call_with_fallback()` L318: 6 参数数量
- 📏 `call_with_fallback()` L401: 6 参数数量
- 🏗️ `_format_input_data()` L27: 中等嵌套: 3
- 🏗️ `_post_process_response()` L421: 嵌套过深: 5
- ❌ L243: 未处理的易出错调用
- ❌ L253: 未处理的易出错调用
- 🏷️ `_format_input_data()` L27: "_format_input_data" - snake_case
- 🏷️ `_strip_reasoning_blocks()` L57: "_strip_reasoning_blocks" - snake_case
- 🏷️ `_parse_json_response()` L69: "_parse_json_response" - snake_case
- 🏷️ `_coerce_message_text()` L114: "_coerce_message_text" - snake_case
- 🏷️ `_repair_json_response()` L127: "_repair_json_response" - snake_case
- 🏷️ `_restore_temperature()` L151: "_restore_temperature" - snake_case
- 🏷️ `_apply_temperature_override()` L157: "_apply_temperature_override" - snake_case
- 🏷️ `_build_retry_prompt()` L166: "_build_retry_prompt" - snake_case
- 🏷️ `_finalize_success_response()` L175: "_finalize_success_response" - snake_case
- 🏷️ `_run_agent_json_call()` L185: "_run_agent_json_call" - snake_case

**详情**:
- 循环复杂度: 平均: 3.9, 最大: 11
- 认知复杂度: 平均: 6.6, 最大: 19
- 嵌套深度: 平均: 1.4, 最大: 5
- 函数长度: 平均: 22.9 行, 最大: 82 行
- 文件长度: 390 代码量 (443 总计)
- 参数数量: 平均: 3.3, 最大: 7
- 代码重复: 0.0% 重复 (0/17)
- 结构分析: 2 个结构问题
...
### 11. backend\common\question_options.py

**糟糕指数: 24.63**

> 行数: 257 总计, 213 代码, 0 注释 | 函数: 8 | 类: 0

**问题**: 🔄 复杂度问题: 5, ⚠️ 其他问题: 2, 🏗️ 结构问题: 1, ❌ 错误处理问题: 16, 📝 注释问题: 1

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `normalize_question_options` | L68-124 | 57 | 23 | 2 | 2 | ✓ |
| `build_answer_display` | L186-221 | 36 | 11 | 2 | 3 | ✓ |
| `answer_tokens` | L34-65 | 32 | 8 | 3 | 2 | ✓ |
| `format_option_display` | L172-183 | 12 | 7 | 0 | 1 | ✓ |
| `serialize_answer_payload` | L224-244 | 21 | 7 | 2 | 2 | ✓ |
| `clean_display_text` | L14-31 | 18 | 5 | 2 | 1 | ✓ |
| `option_tokens` | L127-144 | 18 | 3 | 2 | 1 | ✓ |
| `decorate_question_options` | L147-169 | 23 | 1 | 0 | 4 | ✓ |

**全部问题 (23)**

- 🔄 `normalize_question_options()` L68: 复杂度: 23
- 🔄 `build_answer_display()` L186: 复杂度: 11
- 🔄 `answer_tokens()` L34: 认知复杂度: 14
- 🔄 `normalize_question_options()` L68: 认知复杂度: 27
- 🔄 `build_answer_display()` L186: 认知复杂度: 15
- 📏 `normalize_question_options()` L68: 57 代码量
- 🏗️ `answer_tokens()` L34: 中等嵌套: 3
- ❌ L90: 未处理的易出错调用
- ❌ L91: 未处理的易出错调用
- ❌ L92: 未处理的易出错调用
- ❌ L93: 未处理的易出错调用
...
- 认知复杂度: 平均: 11.4, 最大: 27
- 嵌套深度: 平均: 1.6, 最大: 3
- 函数长度: 平均: 27.1 行, 最大: 57 行
- 文件长度: 213 代码量 (257 总计)
- 参数数量: 平均: 2.0, 最大: 4
- 代码重复: 0.0% 重复 (0/8)
- 结构分析: 1 个结构问题
- 错误处理: 16/18 个错误被忽略 (88.9%)
- 注释比例: 0.0% (0/213)
- 命名规范: 无命名违规

### 12. backend\ai_services\student_rag_views.py

**糟糕指数: 23.62**

> 行数: 175 总计, 142 代码, 10 注释 | 函数: 2 | 类: 0

**问题**: 🔄 复杂度问题: 2, ⚠️ 其他问题: 2, ❌ 错误处理问题: 6, 📝 注释问题: 1

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `ai_node_intro` | L100-174 | 75 | 19 | 1 | 1 | ✓ |
| `ai_path_planning` | L27-95 | 69 | 8 | 1 | 1 | ✓ |

**全部问题 (10)**

- 🔄 `ai_node_intro()` L100: 复杂度: 19
- 🔄 `ai_node_intro()` L100: 认知复杂度: 21
- 📏 `ai_path_planning()` L27: 69 代码量
- 📏 `ai_node_intro()` L100: 75 代码量
- ❌ L82: 未处理的易出错调用
- ❌ L91: 未处理的易出错调用
- ❌ L92: 未处理的易出错调用
- ❌ L150: 未处理的易出错调用
...
- 认知复杂度: 平均: 15.5, 最大: 21
- 嵌套深度: 平均: 1.0, 最大: 1
- 函数长度: 平均: 72.0 行, 最大: 75 行
- 文件长度: 142 代码量 (175 总计)
- 参数数量: 平均: 1.0, 最大: 1
- 代码重复: 未发现函数
- 结构分析: 0 个结构问题
- 错误处理: 6/18 个错误被忽略 (33.3%)
- 注释比例: 7.0% (10/142)
- 命名规范: 无命名违规

### 13. backend\knowledge\teacher_resource_views.py
...
### 14. backend\users\admin_user_management_views.py
...
### 15. backend\users\auth_views.py
...
### 16. backend\courses\teacher_course_views.py
...
### 17. backend\ai_services\services\student_graph_rag_service.py
...
### 18. backend\learning\student_rag_views.py
...
### 19. backend\tools\dkt_training.py
...
### 21. backend\common\defense_demo_stage.py
...
### 22. backend\tools\dkt_synthetic_support.py
...
### 23. backend\tools\dkt_sequences.py
...
### 24. backend\exams\student_exam_views.py
...
### 25. backend\platform_ai\llm\agent_support.py
...
### 27. backend\knowledge\map_views.py
...
### 28. backend\ai_services\services\path_generation_support.py
...
### 29. backend\ai_services\services\dkt_inference.py
...
### 32. backend\tools\api_regression_helpers.py
...
### 33. backend\ai_services\services\mefkt_runtime_support.py
...
### 34. backend\tools\question_import_support.py
...
### 35. backend\knowledge\teacher_question_views.py
...
### 36. frontend\scripts\browser-audit.mjs
...
### 37. backend\exams\teacher_exam_management_views.py
...
### 38. backend\platform_ai\rag\student_point_path_mixin.py
...
### 39. backend\exams\report_service.py
...
### 40. backend\tools\mefkt_public_data.py
...
### 43. backend\platform_ai\rag\runtime_graph_query_support.py
...
### 44. backend\users\profile_generation.py
...
### 46. backend\assessments\habit_views.py
...
### 47. backend\learning\stage_test_submission.py
...
### 48. backend\tools\knowledge_import_support.py
...
### 49. backend\platform_ai\mcp\resources.py
...
### 50. backend\assessments\status_profile_views.py
...
### 52. backend\assessments\knowledge_assessment_logic.py
...
### 53. backend\ai_services\student_ai_chat_views.py
...
### 54. backend\platform_ai\rag\runtime_search_mixin.py
...
### 55. backend\common\defense_demo_assessment_state.py
...
### 56. backend\common\defense_demo_assessment_support.py
...
### 57. backend\assessments\knowledge_views.py
...
### 58. backend\ai_services\services\web_search_service.py
...
### 59. backend\models\MEFKT\attribute.py
...
### 60. backend\exams\report_service_support.py
...
### 62. backend\common\defense_demo_assessment_questions.py
...
### 63. backend\tools\bootstrap_support.py
...
### 64. backend\tools\demo_course_archive.py
...
### 65. backend\knowledge\services.py
...
### 66. backend\wisdom_edu_api\settings_ai.py
...
### 67. backend\platform_ai\rag\corpus_builder.py
...
### 68. backend\tools\db_demo_preset_support.py

**糟糕指数: 15.32**

> 行数: 238 总计, 214 代码, 0 注释 | 函数: 6 | 类: 1

**问题**: ⚠️ 其他问题: 3, ❌ 错误处理问题: 5, 📝 注释问题: 1

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `build_student1_answer_value` | L82-105 | 24 | 10 | 1 | 2 | ✓ |
| `rebuild_student1_path` | L175-237 | 63 | 4 | 2 | 7 | ✓ |
| `build_student1_demo_defaults` | L22-79 | 58 | 1 | 0 | 0 | ✓ |
| `apply_student1_static_state` | L108-127 | 20 | 1 | 0 | 3 | ✓ |
| `build_mastery_payload` | L130-139 | 10 | 1 | 0 | 3 | ✓ |
| `build_student1_feedback_defaults` | L142-172 | 31 | 1 | 0 | 5 | ✓ |

**全部问题 (8)**

- 📏 `build_student1_demo_defaults()` L22: 58 代码量
- 📏 `rebuild_student1_path()` L175: 63 代码量
- 📏 `rebuild_student1_path()` L175: 7 参数数量
- ❌ L91: 未处理的易出错调用
- ❌ L93: 未处理的易出错调用
- ❌ L136: 未处理的易出错调用
- ❌ L198: 未处理的易出错调用
...
- 认知复杂度: 平均: 4.0, 最大: 12
- 嵌套深度: 平均: 0.5, 最大: 2
- 函数长度: 平均: 34.3 行, 最大: 63 行
- 文件长度: 214 代码量 (238 总计)
- 参数数量: 平均: 3.3, 最大: 7
- 代码重复: 0.0% 重复 (0/6)
- 结构分析: 0 个结构问题
- 错误处理: 5/6 个错误被忽略 (83.3%)
- 注释比例: 0.0% (0/214)
- 命名规范: 无命名违规

### 69. backend\tools\dkt_training_support.py
...
### 70. backend\platform_ai\rag\runtime.py
...
### 71. backend\platform_ai\rag\student_context_mixin.py
...
### 72. backend\platform_ai\llm\agent.py
...
### 73. backend\tools\db_seed_support.py
...
### 74. backend\tools\ai_services_test.py
...
### 75. backend\ai_services\services\kt_prediction_stats.py
...
### 76. backend\exams\student_submission_support.py
...
### 77. backend\ai_services\services\kt_service.py
...
### 78. backend\platform_ai\rag\student_resource_mixin.py
...
### 79. backend\tools\dkt_data_access.py
...
### 80. backend\ai_services\services\kt_model_runtime.py
...
### 81. backend\ai_services\student_ai_profile_views.py
...
### 82. backend\courses\admin_statistics_views.py
...
### 83. backend\platform_ai\rag\student_retrieval_mixin.py
...
### 84. backend\courses\admin_views.py
...
### 85. backend\ai_services\services\llm_resource_support.py
...
### 86. backend\common\course_utils.py
...
### 87. backend\knowledge\teacher_point_views.py
...
### 88. backend\tools\dkt_synthetic.py
...
### 90. backend\ai_services\services\path_service.py
...
### 93. backend\tools\api_regression_student_learning.py
...
### 94. backend\courses\teacher_invitation_views.py
...
### 95. backend\courses\student_views.py
...
### 96. backend\platform_ai\rag\runtime_models.py
...
### 97. backend\knowledge\resource_views.py
...
### 98. backend\tools\api_regression_teacher.py
...
### 99. backend\users\admin_profile_views.py
...
### 100. backend\ai_services\services\kt_prediction_modes.py
...
### 101. backend\users\test_models.py
...
### 102. backend\learning\serializers.py
...
### 103. backend\tools\api_regression_student_exam_ai.py
...
### 104. backend\tools\api_regression_student_basics.py
...
### 105. backend\ai_services\test_student_rag_context.py
...
### 106. backend\knowledge\teacher_map_support.py
...
### 107. backend\platform_ai\rag\runtime_materialization_mixin.py
...
### 108. backend\common\defense_demo_path.py
...
### 110. backend\learning\path_views.py
...
### 112. backend\tools\db_management.py
...
### 113. backend\platform_ai\rag\runtime_graph_query_mixin.py
...
### 114. backend\assessments\knowledge_generation.py
...
### 115. backend\ai_services\services\llm_profile_path_support.py
...
### 116. backend\assessments\assessment_helpers.py
...
### 118. backend\tools\activation.py
...
### 119. backend\ai_services\services\llm_service.py
...
### 120. backend\ai_services\test_student_rag_base.py
...
### 121. backend\learning\dashboard_views.py
...
### 123. backend\users\test_class_api.py
...
### 124. backend\learning\path_rules.py
...
### 125. backend\courses\teacher_workspace_views.py
...
### 126. backend\assessments\knowledge_generation_support.py
...
### 127. backend\ai_services\services\scoring_service.py
...
### 128. backend\learning\stage_test_results.py
...
### 129. backend\courses\teacher_class_views.py
...
### 130. frontend\src\views\student\useLearningPath.js
...
### 131. backend\ai_services\test_student_ai_multicourse.py
...
### 132. backend\learning\stage_test_feedback.py
...
### 134. backend\ai_services\services\mefkt_runtime.py
...
### 135. backend\tools\api_regression_admin_support.py
...
### 136. backend\models\DKT\KnowledgeTracing\data\dataloader.py
...
### 137. backend\learning\stage_test_selection.py
...
### 138. backend\common\defense_demo_content.py
...
### 139. backend\logs\descriptions.py
...
### 140. backend\platform_ai\rag\student_index_mixin.py
...
### 141. backend\users\teacher_profile_support.py
...
### 142. backend\ai_services\test_kt_models.py
...
### 143. backend\tools\rebuild_demo_support.py
...
### 144. backend\ai_services\kt_views.py
...
### 145. backend\exams\student_helpers.py
...
### 146. backend\ai_services\consumers.py
...
### 148. frontend\src\views\teacher\useTeacherResourceManage.js
...
### 149. backend\knowledge\teacher_relation_views.py
...
### 150. frontend\src\components\knowledge\useKnowledgeGraphD3.js
...
### 151. backend\models\MEFKT\sequence.py
...
### 152. backend\exams\student_submission_views.py
...
### 154. backend\ai_services\test_llm_service.py
...
### 158. backend\ai_services\services\llm_profile_path_mixin.py
...
### 159. backend\knowledge\serializers.py
...
### 160. backend\users\admin_activation_views.py
...
### 161. backend\tools\diagnostics.py
...
### 162. backend\wisdom_edu_api\settings.py
...
### 163. backend\ai_services\services\llm_resource_mixin.py
...
### 164. backend\exams\teacher_helpers.py
...
### 165. backend\common\responses.py
...
### 166. backend\common\defense_demo_accounts.py
...
### 167. backend\learning\view_helpers.py
...
### 168. backend\ai_services\services\dkt_inference_support.py
...
### 169. backend\courses\teacher_announcement_views.py
...
### 170. backend\courses\teacher_course_helpers.py
...
### 172. backend\knowledge\teacher_map_views.py
...
### 173. backend\common\defense_demo_progress.py
...
### 176. backend\exams\student_feedback_views.py
...
### 177. frontend\src\views\student\useExamTaking.js
...
### 180. backend\exams\teacher_question_views.py
...
### 181. backend\tools\api_regression_student.py
...
### 183. backend\exams\teacher_result_views.py
...
### 184. backend\tools\excel_templates.py
...
### 185. frontend\src\views\teacher\knowledgeManageModels.js
...
### 186. frontend\src\views\student\useStudentKnowledgeMap.js
...
### 187. frontend\src\views\student\knowledgeMapModels.js
...
### 188. backend\models\MEFKT\graph.py
...
### 189. backend\models\DKT\KnowledgeTracing\data\readdata.py
...
### 190. backend\common\defense_demo_environment.py
...
### 191. frontend\src\api\backend.ts
...
### 203. backend\models\DKT\KnowledgeTracing\evaluation\eval.py
...
### 210. backend\tools\api_regression.py
...
### 211. frontend\src\stores\course.ts
...
### 212. backend\assessments\tests.py
...
### 213. backend\assessments\serializers.py
...
### 214. frontend\src\views\teacher\useTeacherQuestionList.js
...
### 215. backend\platform_ai\rag\corpus_utils.py
...
### 217. backend\ai_services\test_student_rag_runtime.py
...
### 218. backend\common\logging_utils.py
...
### 219. backend\platform_ai\rag\resource_utils.py
...
### 220. backend\platform_ai\rag\student_dependencies.py
...
### 221. backend\common\defense_demo_public.py
...
### 223. backend\platform_ai\rag\runtime_proxies.py
...
### 224. frontend\src\views\teacher\questionListModels.js
...
### 225. backend\models\MEFKT\fusion.py
...
### 227. frontend\src\api\student\ai.ts
...
### 228. backend\application\teacher\contracts.py
...
### 229. backend\users\serializers.py
...
### 230. backend\logs\logging_setup.py
...
### 231. backend\assessments\question_models.py
...
### 232. backend\assessments\history_models.py
...
### 233. backend\ai_services\models.py
...
### 235. frontend\src\views\student\useProfileView.js
...
### 236. backend\application\teacher\workspace.py
...
### 237. backend\assessments\assessment_models.py
...
### 239. backend\ai_services\test_web_search.py
...
### 240. backend\knowledge\models.py
...
### 242. backend\platform_ai\kt\torch_device.py
...
### 243. backend\exams\score_policy.py
...
### 244. frontend\src\views\student\profileModels.js
...
### 245. backend\learning\models.py
...
### 247. backend\platform_ai\search\providers.py
...
### 248. backend\exams\serializers.py
...
### 250. backend\models\DKT\KnowledgeTracing\data\DKTDataSet.py
...
### 251. frontend\src\api\errors.ts
...
### 253. frontend\src\views\student\useFeedbackReport.js
...
### 254. backend\ai_services\auth.py
...
### 255. backend\models\DKT\KnowledgeTracing\model\RNNModel.py
...
### 256. frontend\src\views\teacher\useTeacherKnowledgeManage.js
...
### 257. backend\common\pagination.py
...
### 258. backend\wisdom_edu_api\wsgi.py
...
### 259. backend\wisdom_edu_api\asgi.py
...
### 262. backend\users\admin_views.py
...
### 265. backend\logs\serializers.py
...
### 269. backend\learning\stage_test_models.py
...
### 270. backend\learning\stage_test_get_views.py
...
### 273. backend\knowledge\views.py
...
### 274. backend\knowledge\teacher_views.py
...
### 276. backend\knowledge\admin.py
...
### 277. backend\exams\teacher_views.py
...
### 278. backend\exams\student_class_views.py
...
### 281. backend\courses\teacher_views.py
...
### 282. backend\courses\serializers.py
...
### 283. backend\courses\course_cleanup.py
...
### 286. backend\common\test_responses.py
...
### 291. backend\assessments\views.py
...
### 292. backend\assessments\models.py
...
### 293. backend\assessments\habit_survey_defaults.py
...
### 294. backend\assessments\apps.py
...
### 295. backend\assessments\admin.py
...
### 296. backend\assessments\ability_survey_defaults.py
...
### 297. backend\application\__init__.py
...
### 298. backend\ai_services\views.py
...
### 299. backend\ai_services\tests.py
...
### 300. backend\ai_services\student_ai_views.py
...
### 301. backend\ai_services\serializers.py
...
### 302. backend\ai_services\routing.py
...
### 303. backend\ai_services\apps.py
...
### 304. backend\ai_services\admin.py
...
### 305. frontend\src\utils\markdown.ts
...
### 306. frontend\src\stores\index.ts
...
### 308. frontend\src\api\course.ts
...
### 309. frontend\src\api\authTokens.ts
...
### 311. backend\platform_ai\search\__init__.py
...
### 312. backend\platform_ai\rag\__init__.py
...
### 313. backend\platform_ai\rag\student.py
...
### 314. backend\platform_ai\rag\runtime_course.py
...
### 315. backend\platform_ai\rag\corpus_types.py
...
### 316. backend\platform_ai\rag\corpus_storage.py
...
### 317. backend\platform_ai\rag\corpus.py
...
### 318. backend\platform_ai\llm\__init__.py
...
### 319. backend\platform_ai\llm\facade.py
...
### 320. backend\platform_ai\mcp\__init__.py
...
### 321. backend\platform_ai\kt\__init__.py
...
### 322. backend\platform_ai\kt\facade.py
...
### 323. backend\platform_ai\kt\datasets.py
...
### 324. backend\models\MEFKT\constants.py
...
### 325. backend\application\teacher\__init__.py
...
### 326. backend\ai_services\services\__init__.py
...
### 327. frontend\src\views\teacher\resourceManageModels.js
...
### 328. frontend\src\views\student\learningPathModels.js
...
### 329. frontend\src\views\student\examTakingModels.js
...
### 330. frontend\src\components\knowledge\knowledgeGraphModels.js
...
### 331. frontend\src\api\teacher\settings.ts
...
### 332. frontend\src\api\teacher\question.ts
...
### 333. frontend\src\api\teacher\knowledge.ts
...
### 334. frontend\src\api\teacher\index.ts
...
### 335. frontend\src\api\teacher\exam.ts
...
### 336. frontend\src\api\teacher\course.ts
...
### 337. frontend\src\api\teacher\class.ts
...
### 338. frontend\src\api\student\profile.ts
...
### 339. frontend\src\api\student\learning.ts
...
### 340. frontend\src\api\student\knowledge.ts
...
### 341. frontend\src\api\student\index.ts
...
### 342. frontend\src\api\student\exam.ts
...
### 343. frontend\src\api\student\class.ts
...
### 344. frontend\src\api\student\assessment.ts
...
### 345. frontend\src\api\admin\user.ts
...
### 346. frontend\src\api\admin\statistics.ts
...
### 347. frontend\src\api\admin\profile.ts
...
### 348. frontend\src\api\admin\log.ts
...
### 349. frontend\src\api\admin\course.ts
...
### 350. frontend\src\api\admin\class.ts
...
### 351. frontend\src\api\admin\activation.ts
...
### 352. backend\users\auth_password_views.py
...
### 353. frontend\src\api\common.ts
...
### 354. backend\models\DKT\KnowledgeTracing\evaluation\run.py
...
### 355. backend\tools\browser_audit.py
...
### 356. backend\ai_services\migrations\0001_initial.py
...
### 357. frontend\src\router\guards.ts
...
### 358. backend\ai_services\services\llm_provider_config.py
...
### 359. backend\exams\migrations\0001_initial.py
...
### 360. backend\logs\migrations\0001_initial.py
...
### 361. frontend\src\composables\useCourse.ts
...
### 362. backend\learning\migrations\0001_initial.py
...
### 363. backend\assessments\migrations\0001_initial.py
...
### 365. backend\knowledge\migrations\0001_initial.py
...
### 366. backend\courses\migrations\0001_initial.py
...
### 367. backend\users\migrations\0001_initial.py
...
### 368. backend\tools\rebuild_demo.py
...
### 369. backend\courses\admin_course_class_stats_views.py
...
### 372. frontend\src\utils\courseCover.ts
...
### 373. backend\assessments\migrations\0004_alter_surveyquestion_options_and_more.py
...
### 374. backend\users\migrations\0005_remove_habitpreference_reminder_settings.py
...
### 376. frontend\src\composables\useAIProgress.ts
...
### 377. backend\courses\migrations\0005_announcement.py
...
### 378. backend\exams\student_views.py
...
### 380. backend\users\migrations\0004_alter_habitpreference_review_frequency.py
...
### 381. backend\logs\migrations\0002_alter_operationlog_module.py
...
### 382. backend\learning\migrations\0005_nodeprogress_extra_data.py
...
### 383. backend\learning\migrations\0003_add_skipped_status.py
...
### 384. backend\knowledge\migrations\0005_alter_knowledgerelation_relation_type.py
...
### 385. backend\courses\migrations\0004_course_config.py
...
### 386. backend\ai_services\migrations\0003_add_chat_kt_call_types.py
...
### 387. frontend\src\utils\logger.ts
...
### 388. backend\users\migrations\0002_habitpreference_accept_challenge_and_more.py
...
### 390. backend\users\migrations\0003_alter_user_email_alter_user_phone.py
...
### 391. backend\learning\migrations\0004_pathnode_estimated_minutes_pathnode_node_type.py
...
### 392. backend\assessments\migrations\0006_assessmentstatus_generating_and_more.py
...
### 393. backend\assessments\migrations\0005_question_chapter_question_suggested_score.py
...
### 394. backend\assessments\migrations\0002_initial.py
...
### 395. backend\knowledge\migrations\0004_resource_chapter_number_resource_duration_and_more.py
...
### 396. backend\common\defense_demo.py
...
### 397. backend\courses\migrations\0003_alter_class_options_class_description_and_more.py
...
### 398. backend\ai_services\migrations\0002_initial.py
...
### 399. backend\common\permissions.py
...
### 400. backend\knowledge\migrations\0003_knowledgepoint_category_and_more.py
...
### 401. frontend\src\stores\assessment.ts
...
### 402. frontend\src\router\routes\auth.ts
...
### 403. backend\wisdom_edu_api\urls.py
...
### 404. backend\platform_ai\__init__.py
...
### 405. backend\courses\migrations\0002_initial.py
...
### 407. backend\ai_services\urls.py
...
### 409. backend\exams\migrations\0002_initial.py
...
### 410. backend\knowledge\migrations\0002_initial.py
...
### 411. backend\assessments\migrations\0003_initial.py
...
### 412. backend\learning\migrations\0002_initial.py
...
### 413. frontend\src\router\index.ts
...
### 415. backend\courses\signals.py
...
### 416. backend\ai_services\services\mefkt_loader.py
...
### 417. frontend\src\router\routes\teacher.ts
...
### 419. backend\models\MEFKT\__init__.py
...
### 420. frontend\src\router\routes\student.ts
...
### 423. backend\knowledge\migrations\0006_knowledgepoint_introduction_fields.py
...
### 424. backend\models\MEFKT\model.py
...
### 426. backend\models\DKT\KnowledgeTracing\Constant\Constants.py
...
### 428. backend\wisdom_edu_api\__init__.py
...
### 432. backend\tools\mefkt_paths.py
...
### 434. backend\learning\__init__.py
...
### 436. backend\knowledge\__init__.py
...
### 442. backend\common\__init__.py
...
### 444. backend\assessments\__init__.py
...
### 445. backend\assessments\urls.py
...
### 446. backend\ai_services\__init__.py
...
### 447. backend\users\migrations\__init__.py
...
### 448. backend\logs\migrations\__init__.py
...
### 449. backend\learning\migrations\__init__.py
...
### 450. backend\knowledge\migrations\__init__.py
...
### 451. backend\exams\migrations\__init__.py
...
### 452. backend\courses\migrations\__init__.py
...
### 453. backend\common\migrations\__init__.py
...
### 454. backend\assessments\migrations\__init__.py
...
### 455. backend\ai_services\migrations\__init__.py
...
### 456. frontend\src\router\routes\admin.ts
...
### 457. frontend\src\api\admin\index.ts
...
### 458. backend\models\DKT\KnowledgeTracing\model\__init__.py
...
### 459. backend\models\DKT\KnowledgeTracing\evaluation\__init__.py
...
### 460. backend\models\DKT\KnowledgeTracing\data\__init__.py
...
### 461. backend\models\DKT\KnowledgeTracing\Constant\__init__.py
...
| 函数 | 文件 | 复杂度 | 嵌套 | 行数 |
|:-----|:-----|------:|------:|------:|
| `get_profile` | backend\users\student_views.py | 35 | 2 | 128 |
| `resource_update` | backend\knowledge\teacher_resource_views.py | 24 | 2 | 70 |
| `normalize_question_options` | backend\common\question_options.py | 23 | 2 | 57 |
| `load_model` | backend\ai_services\services\mefkt_inference.py | 23 | 2 | 91 |
...
| `_preset_student1_demo_data` | backend\tools\db_demo_preset.py | 19 | 3 | 199 |
